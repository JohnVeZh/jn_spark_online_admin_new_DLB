...
public class JPushClientUtil{
  ...
  private static final String appKey =DictionaryUtils.APPKEY;	//必填，例如466f7032ac604e02fb7bda89

  private static final String masterSecret = DictionaryUtils.MASTERSECRET;//"13ac09b17715bd117163d8a1";//必填，每个应用都对应一个masterSecret
  ...
  public static void main(String[] args) {
    ...
    //测试发送消息或者通知
    testSend("星火英语","星火英语","123123123123123123123123");
  }

  public static void testSend( String msgTitle,String msgContent,String id) {
