/**
 * EmailParaForm.java   2012-5-25 下午5:15:31
...
/**
 *
 * @Description 邮件参数表单元素
 *
 * @author YuPeng
 * @date 2012-5-25 下午5:15:31
 */

@SuppressWarnings("serial")
public class EmailParaForm extends ActionForm{
	//编号
	private String id;
	//发件人
...
/*	public String getAuthClassNm() {
		return authClassNm;
	}
	public void setAuthClassNm(String authClassNm) {
		this.authClassNm = authClassNm;
	}*/
