...
public class TbSpecialSuggestion extends
	...
	/** default constructor */
	public TbSpecialSuggestion() {
	}

	/** minimal constructor */
	public TbSpecialSuggestion(String id) {
		this.id = id;
	}

	/** full constructor */
	public TbSpecialSuggestion(String id, String section, String trainingType,
