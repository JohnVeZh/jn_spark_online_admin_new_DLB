...
public class PreferentialCodeMgr extends AbstractHibernateDAO {
	 ...
	 *           要抛出的异常 可定义多个
	 */
	public void add(PreferentialCodeActionForm vo) throws SystemException, Exception {
		Transaction tx = null;
		 
		try {
			PreferentialCode po = new PreferentialCode();
	...
	*更新
	*/
	public void update(PreferentialCodeActionForm vo) throws SystemException, Exception {
		Transaction tx = null;
		try {
		
			Session session = HibernateSessionFactory.openSession();
			tx = session.beginTransaction();
			PreferentialCode po = (PreferentialCode) session.load(PreferentialCode.class, vo.getId());
			super.copyProperties(po, vo);
			session.update(po);
			tx.commit();
		} catch (Exception e) {
	 ...
	 * @throws Exception
	 */
	public PreferentialCodeActionForm view(String ID) throws SystemException, Exception {
		try {
			Session ses = HibernateSessionFactory.openSession();
			PreferentialCode po = (PreferentialCode) ses.load(PreferentialCode.class, ID);
			PreferentialCodeActionForm form = new PreferentialCodeActionForm();
