...
public class JCommonWords extends com.easecom.common.framework.hibernate.BaseModel
...
/** default constructor */
    ...
    public JCommonWords (int testFrequency,String ctId,String createtime,String audioPath,String phonogram,String id,String word,String content,int sort) {
      this.testFrequency = testFrequency;
      this.ctId = ctId;
      this.createtime = createtime;
      this.audioPath = audioPath;
