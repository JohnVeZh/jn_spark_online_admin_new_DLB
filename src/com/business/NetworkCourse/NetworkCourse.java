...
public class NetworkCourse extends BaseForm  implements Serializable {
	...
	public void setNcQqGroup(String ncQqGroup) {
		this.ncQqGroup = ncQqGroup;
	}
	public String getNcLiveRome() {
		return ncLiveRome;
	}
	public void setNcLiveRome(String ncLiveRome) {
		this.ncLiveRome = ncLiveRome;
	}
	@Override
	public String toString() {
		return "NetworkCourse [id=" + id + ", ncName=" + ncName + ", ncBrief="
				...
				+ saleTime + ", saleEndTime=" + saleEndTime + ", onShelfTime="
				+ onShelfTime + ", offShelfTime=" + offShelfTime
				+ ", limitNumber=" + limitNumber + ", reserveNumber="
				+ reserveNumber + ", saleNumber=" + saleNumber + ", ncState="
				+ ncState + ", ncLevel=" + ncLevel + ", ncLevelType="
				+ ncLevelType + ", sort=" + sort + ", isFree=" + isFree
				+ ", isLimitFree=" + isLimitFree + ", limitStartTime="
				+ limitStartTime + ", limitEndTime=" + limitEndTime
				+ ", isIndex=" + isIndex + ", isDelete=" + isDelete
				+ ", evaluateCount=" + evaluateCount + ", isTeacher="
				+ isTeacher + ", isCatalog=" + isCatalog + ", isPublic="
				+ isPublic + ", isGiftBook=" + isGiftBook + ", giftBookPrice="
				+ giftBookPrice + ", createTime=" + createTime + ", ncQqGroup="
				+ ncQqGroup + ", ncLiveRome=" + ncLiveRome + ", file=" + file
				+ "]";
	}
