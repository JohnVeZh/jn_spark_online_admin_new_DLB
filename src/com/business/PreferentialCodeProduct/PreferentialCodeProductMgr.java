...
public class PreferentialCodeProductMgr extends AbstractHibernateDAO {
	 ...
	 *           要抛出的异常 可定义多个
	 */
	public void add(PreferentialCodeProductActionForm vo) throws SystemException, Exception {
		Transaction tx = null;
		 
		try {
			PreferentialCodeProduct po = new PreferentialCodeProduct();
	...
	*更新
	*/
	public void update(PreferentialCodeProductActionForm vo) throws SystemException, Exception {
		Transaction tx = null;
		try {
	 ...
	 * @throws Exception
	 */
	public PreferentialCodeProductActionForm view(String ID) throws SystemException, Exception {
		try {
			Session ses = HibernateSessionFactory.openSession();
			PreferentialCodeProduct po = (PreferentialCodeProduct) ses.load(PreferentialCodeProduct.class, ID);
			PreferentialCodeProductActionForm form = new PreferentialCodeProductActionForm();
	...
	public ListContainer list(Collection queryConds, int currentPageInt,
		...
		try {
			...
			String hq = "from PreferentialCodeProduct as PreferentialCodeProduct where 1=1 "
					...
					+ " order by PreferentialCodeProduct.createtime desc   ";
			Query qCount = ses
