...
<%@page import="com.business.MatchedPapersTopicTranslate.MatchedPapersTopicTranslateActionForm"%>
<%
...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：matched_papers_topic_translate_edit<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
 		  <html:form  action="business/MatchedPapersTopicTranslate.do?act=update" method="post"  onsubmit="return sub(this)">
