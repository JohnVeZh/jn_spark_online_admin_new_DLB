...
<%@page import="com.business.JQrSubtitleListeningLyric.JQrSubtitleListeningLyric"%>
<%
...
<link rel="stylesheet" type="text/css" id="theme"/>
 <!--3.3框架必需end-->
	...
	<script type="text/javascript">
		...
		function doDels() {
			...
			if(idVal!=""){
				top.Dialog.confirm("您确信要删除吗?",
				   	function() {
				   		listForm.action="JQrSubtitleListeningLyric.do?act=realdelete"+idVal;
						listForm.submit();
					}
				)
			}
		...
		//添加
		function preAdd(){       
		    listForm.action="JQrSubtitleListeningLyric.do?act=preAdd"
			listForm.submit();
		}
		//修改
		function preUpdate(j) {
			var idVal = isSel();
			if(idVal!=""){
			  listForm.action="JQrSubtitleListeningLyric.do?act=preUpdate"+idVal;
			  listForm.submit();
			}
		}
		//详情
		function view() {
			var idVal = isSel();
			if(idVal!=""){
		  	   listForm.action="JQrSubtitleListeningLyric.do?act=view"+idVal;
		  		listForm.submit();
			}
		}
		//清空查询数据
	...
	<div id="scrollContent">
		<div class="position">
			<div class="center">
				<div class="left">
					<div class="right">
					<span>当前位置：j_qr_subtitle_listening_lyric_list<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
					</div>
				</div>
			</div>
		</div>
		<form name="listForm" scope="request" action="<%=path%>/business/JQrSubtitleListeningLyric.do?act=list" method="post">
			...
			<table  class="tableStyle" mode="list" useCheckbox="true" selectRowButtonOnly="false" id="listTable">
					...
					<tr >
						<th width="3%" height="25" align="center" class="DataTable_Field">
								...
								<th height="25"  align="center" class="DataTable_Field" title="简系列试卷id * 类型：String 长度:32">qrslId</th>								 
								...
								<th height="25"  align="center" class="DataTable_Field" title="排序 * 类型：int 长度:10">sort</th>								 
					</tr>
