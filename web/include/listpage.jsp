...
<table width="98%"  border="0" align="center" cellspacing="0" cellpadding="0">
    <tr >
      <td class="font_12" width="30%"><input type="hidden" name="pageAction" value="">
      ...
      <td class="font_12" width="20%">
         <span style="cursor:hand;display:none;" onclick="javascript:allData('<%=PageAction.JUMP.toString()%>','<%=lc.getTotalItem()%>')"><a href="#">全部数据</a></span>
      </td>
      <td class="font_12" width="50%">
         <div style="border: 0px thin #CCCCCC; float: right;" class="padding_right0">
         		<div style="float: left; border: thin 1px #FFFFFF;">
              <span class="icon_arr1 padding_right10"><a href="javascript:jumpPage('<%=PageAction.JUMP.toString()%>')">跳至</a><span>第&nbsp;</span><input name="jumpPage" type="text" style="width: 30px;height: 20px;" size="3" value="<%=lc.getCurrentPage()%>"><span class="16f">&nbsp;页&nbsp;</span></span>
              </div>
