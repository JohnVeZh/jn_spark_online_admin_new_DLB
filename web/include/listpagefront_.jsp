...
<table width="60%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="77"><img src="images/fanye_01.gif" width="77" height="30"    onclick="javascript:goPage('<%=PageAction.PREVIOUS.toString()%>')"/></td>
                <td width="77" style="color:white;" align="center">第<%=lc.getCurrentPage()%>页/共<%=lc.getTotalPages()%>页</td>
                <td width="77"><img src="images/fanye_02.gif" width="77" height="30"  onclick="javascript:goPage('<%=PageAction.NEXT.toString()%>')" /></td>
              </tr>
            </table>
