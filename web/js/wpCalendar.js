...
document.writeln('<iframe id=wpCalendarLayer name=wpCalendarLayer frameborder=0 onmouseout="wpCalendar.correctPosition()" style="position: absolute; width:183px; height:258px; z-index: 99999; display: none"></iframe>');
...
function wpCalendar(){
	...
	this.versioninfo= "Canlendar Version:2.59&#13;作者:HongTao";	//版本信息
	this.tgtObject	= null;
...
var theme=new Object();
	...
	theme["NewAge"].grayDayFontColor	= "white";	//非本月日期的字体颜色
...
wpCalendar.setTheme('NewAge'); //风格
//wpCalendar.cellwidth='30'; //宽度
//wpCalendar.cellheight='15';//高度
wpCalendar.setDateStyle('yyyy-MM-dd');//日期格式
wpCalendar.redraw();
