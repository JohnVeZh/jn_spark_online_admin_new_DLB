...
<link href="<%=path %>/login_question/skin_flat/style.css" rel="stylesheet" type="text/css" id="skin"/>
		...
		<div class="login_middle">
			...
			<div class="login_middlecenter">
					...
					<div class="login_button">
						...
						<div class="login_button_right"><input type="reset" value=""/><input type="hidden" name="state" value="2"/></div>
						<div class="clear"></div>
					</div>
					</form>
