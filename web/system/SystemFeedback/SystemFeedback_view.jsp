...
<%@page import="com.business.SystemFeedback.SystemFeedbackActionForm"%>
<%
...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：system_feedback_view<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
 		  <html:form  action="business/SystemFeedback.do?act=update" method="post"  onsubmit="return sub(this)">
				...
				<fieldset> 
					<legend>system_feedback基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%">									 
									<html:text property="isSuc" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
