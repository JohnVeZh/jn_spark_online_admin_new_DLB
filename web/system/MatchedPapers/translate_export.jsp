		...
		<div class="center">
			<div class="left">
				<div class="right" align="left">
					<span>当前位置：翻译上传<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
				...
				<c:choose>
					  <c:when test="${textName =='translate'}">
					  	<html:form action="business/MatchedPapers.do?act=zoneTranslate" styleId="formAction"  method="post" enctype="multipart/form-data" onsubmit="return sub(this)">
							<html:file property="file" styleId="file" ></html:file>
						</html:form>
					  </c:when>
					  <c:otherwise>
						<html:form action="business/MatchedPapers.do?act=getUpload_translate" styleId="formAction"  method="post" enctype="multipart/form-data" onsubmit="return sub(this)">
							<html:file property="file" styleId="file" ></html:file>
						</html:form>
					  </c:otherwise>
					</c:choose>
