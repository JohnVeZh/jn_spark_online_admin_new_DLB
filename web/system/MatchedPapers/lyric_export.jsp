	...
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				...
				<html:form action="business/MatchedPapers.do?act=lyricExl" styleId="formAction"  method="post" enctype="multipart/form-data" onsubmit="return sub(this)">
					<input type="text" name="code" value="01" style="display: none"/>
