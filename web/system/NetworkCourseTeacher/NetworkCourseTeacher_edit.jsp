...
<%@page import="com.business.NetworkCourseTeacher.NetworkCourseTeacherActionForm"%>
<%
...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/NetworkCourseTeacher.do?act=update" method="post" id="listForm" target="frmright">
			<input type="text" name="id" value="${NetworkCourseTeacherActionForm.id }" style="display: none"/>
					...
					<legend>基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="40%" align="left">
									<input type="text" style="display: none" name="logo" id="iconPhone" class="validate[] iptClass" value="${NetworkCourseTeacherActionForm.logo }"/>
									...
									<div id="PhoneDiv" style="float: left;padding-right: 20px">
									  <c:if test="${NetworkCourseTeacherActionForm.logo!='' }">
										<a href="javascript:thumbImgsDivList('${NetworkCourseTeacherActionForm.logo }',0,'<%=path%>')" >
											<img src="<%=path%>/${NetworkCourseTeacherActionForm.logo }" style="width: 80px;"/>
										</a>
									</c:if>
									</div>
								</td>--%>
								...
								<td width="40%" align="left">
									<input type="text" style="width: 100%" name="logo" id="logo" placeholder="请输入至少10个字符" class="validate[required] iptClass" value="${NetworkCourseTeacherActionForm.logo }"/>
								</td>
								<td width="10%" align="right">
									<span class="star">*</span>	老师名称：
								</td>
								<td width="40%" align="left">
									<input type="text" name="name" maxlength="10" placeholder="10个汉字以内" class="validate[required] iptClass" value="${NetworkCourseTeacherActionForm.name }"/>
							...
							<tr>
								...
								<td width="40%" align="left">
									<input type="text" name="moblie" class="validate[] iptClass" value="${NetworkCourseTeacherActionForm.moblie }"/>
								...
								<td width="40%" align="left">
									<input type="radio" name="sex" value="0" <c:if test="${NetworkCourseTeacherActionForm.sex==0 }">checked="checked"</c:if>/>男
									<input type="radio" name="sex" value="1" <c:if test="${NetworkCourseTeacherActionForm.sex==1 }">checked="checked"</c:if>/>女
								</td>
							</tr>
							<tr>
								<td width="10%" align="right">
								...
								<td width="90%" align="left" colspan="3">
									<input type="text" name="tags" class="validate[] iptClass" value="${NetworkCourseTeacherActionForm.tags }" />
									<span class="star"></span>
								</td>
							</tr>
								<tr>
								...
								<td width="90%" align="left" colspan="3">
									<div style=" height:250px; overflow:auto; ">
										 <%--<textarea  id="ue_introduce" name="introduce" style="width: 100%"  >${NetworkCourseTeacherActionForm.introduce }</textarea> --%>
											 <textarea id="ue_introduce" rows="10"  maxlength="200" style="width: 90%;height: 95%;" name="introduce"
													   onchange="this.value=this.value.substring(0, 200)"
													   onkeydown="this.value=this.value.substring(0, 200)"
													   onkeyup="this.value=this.value.substring(0, 200)" >${fn:trim(NetworkCourseTeacherActionForm.introduce)}</textarea>
											 <span>200字以内</span>
									</div>
								</td>
							</tr>
