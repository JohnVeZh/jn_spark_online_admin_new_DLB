...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：network_course_teaher_view<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
 		  <html:form  action="business/NetworkCourseTeachter.do?act=update" method="post"  onsubmit="return sub(this)">
			<div class="box1 center" whiteBg="true" id="form1">
				<fieldset> 
					<legend>network_course_teaher基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%">									 
									<html:text property="logo" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
								...
								<td width="35%">									 
									<html:text property="introduce" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
								...
								<td width="35%">									 
									<html:text property="createtiem" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
									<span class="star"><!--* 类型：String 长度:50--></span>
								</td>
							</tr>
								<tr>
								...
								<td width="35%">									 
									<html:text property="moblie" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
									<span class="star"><!--* 类型：String 长度:50--></span>
								</td>
							</tr>
						</table>
