		...
		<div class="center">
			<div class="left">
				<div class="right" align="left">
					<span>当前位置：物流单号导入<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
				<div style="" align="center">
				<html:form action="/business/NetworkCourseOrder.do?act=expressImport" styleId="formAction"  method="post" enctype="multipart/form-data" onsubmit="return sub(this)">
				...
				<div class="diverror" align="left">友情提示：可分批导入，以免处理超时</div>
				<br />
		</div>
</body>
<script language="javascript" type="text/javascript">
	...
	function ajaxFilephones(){
	 ...
	 $('#formAction').ajaxSubmit(function(data){
		    if(data.result){
            	top.Dialog.alert("导入成功！共导入" + data.succNum + "条记录", function() {
            		top.Dialog.close();
            	});
		    } else {
