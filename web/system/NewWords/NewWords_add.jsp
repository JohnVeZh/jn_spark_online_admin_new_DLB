...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/NewWords.do?act=add" method="post" id="listForm" >
					...
					<legend>单词基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%" align="left">
									<input type="text" name="knowledgePointEnId" class="validate[required] iptClass" />
