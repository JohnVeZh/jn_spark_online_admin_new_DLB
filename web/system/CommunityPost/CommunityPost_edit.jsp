...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/CommunityPost.do?act=update" method="post" id="listForm" target="frmright">
		   <input type="text" name="id" value="${CommunityPostActionForm.id }" style="display: none"/>
						...
						<table class="tableStyle" transMode="true" footer="normal">
							<tr>
								...
								<td width="90%" align="left" colspan="3">
									http://dy.sparke.cn/phoneMobile.do?act=sharePostDetail&cpid=${CommunityPostActionForm.id }	
								</td>
							</tr>
							<tr>
								...
								<%--<td width="35%" align="left">--%>
									<%--<input type="text" style="width:100%" name="viewImgpath" id="iconPhone" class="validate[] iptClass" value="${CommunityPostActionForm.viewImgpath }"/>--%>
									...
									<%--<div id="PhoneDiv" style="float: left;padding-right: 20px">--%>
									  <%--<c:if test="${CommunityPostActionForm.viewImgpath!='' }">--%>
									    <%--<div style="padding: 5px 5px 5px 5px;float: left;">--%>
											<%--<c:choose>--%>
												<%--<c:when test="${fn:startsWith(CommunityPostActionForm.viewImgpath,'http' )  }">--%>
													<%--<a href="javascript:thumbImgsDivList('${CommunityPostActionForm.viewImgpath }',0)" >--%>
														<%--<img src="${CommunityPostActionForm.viewImgpath }" style="width: 80px" />--%>
													<%--</a>--%>
												<%--</c:when>--%>
												<%--<c:otherwise>--%>
													<%--<a href="javascript:thumbImgsDivList('${CommunityPostActionForm.viewImgpath }',0,'<%=path%>')" >--%>
														<%--<img src="<%=path%>/${CommunityPostActionForm.viewImgpath }" style="width: 80px" />--%>
													<%--</a>--%>
												<%--</c:otherwise>--%>
											<%--</c:choose>--%>
									    <%--</div>--%>
								...
								<td width="35%" align="left" colspan="3">
									<div id="ptqnsubmit3">
									<input type="text" style="width: 100%;" name="imgpathList" id="iconPhones" class="validate[] iptClass" value="${CommunityPostActionForm.imgpathList }"/>
									<div style="float: left">
										<input id = "qnsubmit3" type="button" value="上传并预览"/>
									</div>
										...
										<c:forEach items="${imgs }" var="img">
											<div style="padding: 5px 5px 5px 5px;float: left;">
												...
												<c:when test="${fn:startsWith(img,'http')}">
													<a href="javascript:thumbImgsDivList('${img }',0)" >
														<img src="${img }" style="width: 80px"/>
													</a>
												</c:when>
													<c:otherwise>
											<a href="javascript:thumbImgsDivList('${img }',0,'<%=path%>')" >
												<img src="<%=path%>/${img }" style="width: 80px"/>
											</a>
													</c:otherwise>
												</c:choose>
											</div>
							...
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									<input type="text" name="title" class="validate[required] iptClass" style="width: 97%" maxNum="100" value="${CommunityPostActionForm.title }"/>
							...
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									<input type="radio" name="isShow" value="0" <c:if test="${CommunityPostActionForm.isShow == 0 }" > checked="checked" </c:if>  /> 隐藏
									<input type="radio" name = "isShow" value="1" <c:if test="${CommunityPostActionForm.isShow == 1 }" > checked="checked" </c:if> /> 展示
								</td>
							</tr>
							<tr>
								<td width="15%" align="right">
								...
								<td width="35%" align="left" colspan="3">
									<input type="text" name="brief" class="validate[required] iptClass" style="width: 97%" maxNum="200" value="${CommunityPostActionForm.brief }"/>
									<span class="star">*</span>
								</td>
							</tr>
								<tr>
								...
								<td width="35%" align="left" colspan="3">
									<div style=" height:450px; overflow:auto; ">
										 <textarea  id="ue_content4" name="countent" style="width: 100% ;height: 440px;"  >${CommunityPostActionForm.countent }</textarea>
										</div>
								</td>
							</tr>
						</table>
		...
		<div style="display: none">
				...
				<input type="text" id="imgsNum" value="0"/>
		</div>
	<!-- 图片展示div -->
...
<script type="text/javascript">
    ...
    $(function(){
        uploadInit4();
        new deboEditor().init("ue_content4");
    })
</script>
...
//                 editor.showUploadProgress(file.percent);
             ...
             'FileUploaded': function (up, file, info) {
                 ...
                 $("#PhoneDivs").html("<img src='"+sourceLink+"' style='width: 80px;'/>");
                 $("#filephone").val("");
