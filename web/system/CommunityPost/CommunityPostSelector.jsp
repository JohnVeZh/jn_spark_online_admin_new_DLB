...
<link rel="stylesheet" type="text/css" id="theme"/>
 <!--3.3框架必需end-->
	...
	<div id="scrollContent">
		<form name="listForm" scope="request" action="<%=path%>/business/CommunityPost.do?act=communityPostSelector&srcpage=${srcpage}&idKey=${idKey}&valueKey=${valueKey}" method="post" >
			...
			<table  class="tableStyle" mode="list" useCheckbox="true" selectRowButtonOnly="false" id="listTable">
				<tr >
					...
					<th height="25" width="60" align="center" class="DataTable_Field" title="查看数量 ">点击数量</th>								 
					<th height="25" width="60" align="center" class="DataTable_Field" title="评论数量">评论数量</th>								 
					<th height="25" width="60" align="center" class="DataTable_Field" title="点赞数量">点赞数量</th>								 
					...
					<th height="25" width="60" align="center" class="DataTable_Field" title="是否加精">是否加精</th>								 
				...
				<c:forEach items="${lc.list}" var="item" varStatus="stat">
					<tr>
	        			...
	        			<td align="left">${item.seeNum}</td>
	        			<td align="left">${item.commentNum}</td>
	        			<td align="left">${item.likeNum}</td>
	        			<td align="left">
	        			...
	        			<td align="left">
	        				<c:if test="${item.isVary==1}">是</c:if>
	        				<c:if test="${item.isVary==0}">否</c:if>
	        			</td>
