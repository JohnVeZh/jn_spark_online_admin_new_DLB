...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：community_post_follow_record_add<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
		<form name="listForm" action="business/CommunityPostFollowRecord.do?act=add" method="post" id="listForm" >
				...
				<fieldset> 
					<legend>community_post_follow_record基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%">
									<input type="text" name="communityPostId" class="validate[required] iptClass" />
