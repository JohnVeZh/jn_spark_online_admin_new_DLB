        ...
        <div class="center">
            <div class="left">
                <div class="right" align="left">
                    <span>当前位置：；六级激活码导入<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
                </div>
            </div>
        </div>
    </div>
...
//        $("#scrollContent").mask("表单正在提交...");
        if(ext == ".XLS" || ext == ".XLSX"){
            formAction.action="<%=path%>/business/BookActivationCode.do?act=sixCodeByExcel";
        }else{
            formAction.action="<%=path%>/business/BookActivationCode.do?act=sixCodeByTxt";
        }
        formAction.submit();
        setTimeout(function () {
            window.location.href="<%=path%>/system/BookActivationCode/export_progress6.jsp";
        },1000)
    }
