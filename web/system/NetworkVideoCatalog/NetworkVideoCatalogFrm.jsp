...
<frameset id="sysfunctionfrm" cols="20%,*" framespacing="1"
	...
	<frame src="<%=path%>/business/NetworkVideoCatalog.do?act=treelist&nvId=${nvId }" id="left" name="leftFrame"
		scrolling="auto" frameSpacing=0 marginHeight=0 frameBorder=no
		LEFTMARGIN="0" TOPMARGIN="0" />
	<frame name="main" id="main" frameborder="no" 
		src="<%=path%>/business/NetworkVideoCatalog.do?act=list&nvId=${nvId }" />
</frameset>
<noframes></noframes>
<body>
