							...
							<tr>
							 <td width="15%" align="right">
							  ...
							  <td width="35%" align="left">
									<html:text property="name" style="width:95%" styleClass="validate[required] iptClass"></html:text>
							  ...
							  <td width="35%" align="left">
									<html:text property="sort" styleClass="validate[required,length[0,10],custom[onlyNumber]] iptClass" onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"></html:text>
									<span class="star">*</span>
								</td>
							</tr>
							<tr>
								...
								<td width="85%" align="left" colspan="3">
								  <div style=" height:450px; overflow:auto; " >
										 <textarea class="sa" id="ue_value" name="content" style="width: 100%"  class="validate[] iptClass" >${SysConfigForm.value }</textarea> 
									</div>
								</td>
							</tr>
