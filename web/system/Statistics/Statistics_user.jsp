...
<body style="overflow-y:hidden;">
		...
		<div class="right ali01">
			<span>当前位置：会员注册统计</span>
		</div>	
		</div>	
		</div>
	</div>		
	<div id="scrollContent" class="border_gray">
	<form name="listForm" scope="request" action="<%=path%>/business/Statistics.do?act=userlist" method="post" id="listForm">
		...
		<fieldset> 
		  	...
		  	<%-- <tr style="border: 0px">
		  		<td  style="border: 0px">
		  			 <span style="color:red">会员总人数：${userNum}人</span>
		  			<div id="chartdiv" >
	  	...
	  	<table  class="tableStyle"  useHover="false" useClick="false" >
					...
					<c:forEach items="${li }" var="ml" varStatus="s">
						<tr>
							...
							<td  align="left">${ml.userName }</td>
							<td  align="left">${ml.mobile }</td>
							<td  align="left">${ml.createtime }</td>
						</tr>
					</c:forEach>
  	 	</table>
</div>
...
<script>
//////////////////////////
var data_xml = "<chart caption='本月会员注册量' palette='1' baseFontSize='12' rotateYAxisName='0'>"+
<% if(data1.size()>0){
