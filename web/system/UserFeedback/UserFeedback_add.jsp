...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：user_feedback_add<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
		<form name="listForm" action="business/UserFeedback.do?act=add" method="post" id="listForm" >
				...
				<fieldset> 
					<legend>user_feedback基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%">
									<input type="text" name="isHandle" class="validate[required] iptClass" />
								...
								<td width="35%">
									<input type="text" name="handleResults" class="validate[required] iptClass" />
									<span class="star">* 类型：String 长度:500</span>
								</td>
							</tr>
								<tr>
