...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/JQrSubtitleListening.do?act=add" method="post" id="listForm" >
						...
						<table class="tableStyle" transMode="true" footer="normal">
							<tr>
								...
								<td width="90%" align="left" >
									<input type="text" name="mpName" class="validate[] iptClass" style="width: 96%" maxNum="500"/>
							...
							<tr>
								...
								<td width="90%" align="left">
									<input type="text" name="hearUrl" class="validate[] iptClass" style="width: 96%"/>
									<span class="star"></span>
								</td>
							</tr>
							<tr>
								...
								<td width="90%" align="left">
									<input type="text" name="qrCode" class="validate[] iptClass" style="width: 96%"/>
									<span class="star"></span>
								</td>
							</tr>
	    ...
	    var num = 0; 
	     var arrbills = "";
	   	$("#mytable").find("tr").each(function(){
   	 	...
   	 	$("#listForm").attr("action","business/JQrSubtitleListening.do?act=add"+arrbills);
