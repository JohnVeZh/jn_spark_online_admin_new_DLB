...
<%@page import="com.business.JQrSubtitleListening.JQrSubtitleListeningActionForm"%>
<%
...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：j_qr_subtitle_listening_view<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
 		  <html:form  action="business/JQrSubtitleListening.do?act=update" method="post"  onsubmit="return sub(this)">
			<div class="box1 center" whiteBg="true" id="form1">
				<fieldset> 
					<legend>j_qr_subtitle_listening基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%">									 
									<html:text property="hearUrl" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
