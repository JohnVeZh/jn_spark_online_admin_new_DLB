    ...
    <form name="listForm" scope="request" action="<%=path%>/business/coupon.do?act=preBindResourceList" method="post">
        ...
        <table  class="tableStyle" mode="list" useCheckbox="true" selectRowButtonOnly="false" id="listTable">
            <tr >
                ...
                <th height="25"  align="center" class="DataTable_Field">资源名称</th>
                <th height="25" style="width: 200px;" align="center" class="DataTable_Field" style="width:80px">简介</th>
            ...
            <c:forEach items="${lc.list}" var="item" varStatus="stat">
                <tr>
                    ...
                    <td class="DataTable_Content" align="left" title="${item.networkName}">${item.networkName}</td>
                    <td class="DataTable_Content" align="left" title="${item.brief}">${item.brief}</td>
                    <td>
