        ...
        <div class="center">
            <div class="left">
                <div class="right" align="left">
                    <span>当前位置：修改优惠券模板</span>
                </div>
            </div>
        </div>
    </div>
    <form name="listForm" action="<%=path%>/business/coupon.do?act=templateUpdate" method="post" id="listForm" >
                ...
                <table class="tableStyle" transMode="true" footer="normal">
                    <tr>
                        ...
                        <td width="85%" align="left" colspan="3">
                            <input type="text" name="title" id="title" style="width:80%" value="${item.title}" maxlength="8"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="15%" align="right">
                        ...
                        <td width="35%" align="left">
                            <input type="radio" name="status" value="1" <c:if test="${item.status == 1}">checked="checked"</c:if> />正常
                        	<input type="radio" name="status" value="0" <c:if test="${item.status == 2}">checked="checked"</c:if> />停用
                        </td>
                    </tr>
                    <tr>
                        <td width="15%" align="right">
                        ...
                        <td width="35%" align="left">
                            <input type="text" name="effectTimeStr" id="effectTime" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" value="<fmt:formatDate value="${item.effectTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" />
                        </td>
                        <td width="15%" align="right">
                            	模板失效时间：
                        </td>
                        <td width="35%" align="left">
                            <input type="text" name="invalidTimeStr" id="invalidTime" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" value="<fmt:formatDate value="${item.invalidTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" />
                        </td>
                    </tr>
                    <tr>
                        <td width="15%" align="right">
                        ...
                        <td width="35%" align="left">
                            <input type="radio" name="discountType" value="1" <c:if test="${item.discountType == 1}">checked="checked"</c:if> />满减
                        	<input type="radio" name="discountType" value="2" <c:if test="${item.discountType == 2}">checked="checked"</c:if> />折扣
                        </td>
                        <td width="15%" align="right" >
                            	折扣率：
                        </td>
                        <td width="35%" align="left">
                            <input type="text"  name="discountRate" id="discountRate" value="<c:if test="${item.discountType == 2}"><fmt:formatNumber value="${item.discountRate}" pattern="0.00" /></c:if>"/>
                        </td>
                    </tr>
                    <tr >
                        <td width="15%" align="right">
                        ...
                        <td width="35%" align="left">
                            <input type="text" name="minMoney" id="minMoney" value="<c:if test="${item.discountType == 1}"><fmt:formatNumber value="${item.minMoney}" pattern="0.00" /></c:if>"/>
                        </td>
                        <td width="15%" align="right">
                           	 	减额：
                        </td>
                        <td width="35%" align="left">
                            <input type="text" name="discountMoney" id="discountMoney" value="<c:if test="${item.discountType == 1}"><fmt:formatNumber value="${item.discountMoney}" pattern="0.00" /></c:if>"/>
                        </td>
                    </tr>
                    <tr>
                        <td width="15%" align="right">
                        ...
                        <td width="35%" align="left">
                            <input type="text" name="effectPeriod" id="effectPeriod" value="${item.effectPeriod}"/>天
                        </td>
                        <td width="15%" align="right">
                            	商品类型：
                        </td>
                        <td width="35%" align="left">
                        	<input type="radio" name="productType" value="1" <c:if test="${item.productType==1}">checked="checked"</c:if>/>图书
                            <input type="radio" name="productType" value="2" <c:if test="${item.productType==2}">checked="checked"</c:if>/>网课
                        </td>
                    </tr>
                    <tr>
                        <td width="15%" align="right">
                        ...
                        <td width="35%" align="left" colspan="3">
                            ...
                            <input type="text" name="productName" id="productName" value="${item.productName }" readonly="readonly" style="width:80%; cursor:pointer;" />
                        </td>
                    </tr>
                </table>
            </fieldset>
