...
<div id="scrollContent">
    ...
    <form name="listForm" action="<%=path%>/business/CouponCode.do?act=codeAdd" method="post" id="listForm" >
        <div class="box1 center" whiteBg="true" id="form1">
            ...
            <fieldset>
                ...
                <div class="lister" style="margin: 15px auto" id="lister" url="<%=path%>/business/CouponCode.do?act=getTemplate4DoubleSelect" fromTitle="未选模版" toTitle="已选模版" listerWidth="400"></div>
                ...
                <table class="tableStyle" transMode="true" footer="normal">
                    <tr>
                        ...
                        <td width="35%" style="text-align: center">
                            <input type="text" name="codeLength" id="codeLength" class="validate[required] iptClass" />
                    ...
                    <tr>
                        ...
                        <td width="35%">
                            <input type="text" name="codeCount" class="validate[required] iptClass" id="codeCount"/>
                            <span class="star">*</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="35%">
                            <input  class="date" type="text" name="effect_time" id="effect_time" dateFmt="yyyy-MM-dd HH:mm:ss" />
                            <span class="star">*</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td width="35%">
                            <input  class="date" type="text" name="invalid_time" id="invalid_time" dateFmt="yyyy-MM-dd HH:mm:ss"  />
                            <span class="star">* </span>
                        </td>
                    </tr>
                </table>
...
<script language="javascript" type="text/javascript">
    ...
    function sub(){
        ...
        if(parseInt(codeLength) < 6){
            top.Dialog.alert("优惠码长度不能小于6！");
            return;
        }
