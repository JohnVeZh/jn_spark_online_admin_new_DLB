...
%>
  ...
  if (document.getElementById) { 
	<%
	    StringBuffer tree=treeMaker.TreeRootInit3(rootid,"系统功能",request.getContextPath()+"/style/normal/images/tree01.gif",request.getContextPath()+"/style/normal/images/tree01.gif","sysFunction.do?act=list&state="+state+"&parentid="+rootid,"main");
