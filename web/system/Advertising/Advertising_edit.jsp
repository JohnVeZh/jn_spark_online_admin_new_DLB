...
<%@page import="com.business.Advertising.AdvertisingActionForm"%>
<%
...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
 		  ...
 		  <html:form  action="business/Advertising.do?act=update" method="post"  onsubmit="return sub(this)">
					...
					<legend>基本信息</legend> 
						<table class="tableStyle" >
								...
								<td width="35%" align="left" align="left" colspan="3">									 
									<html:text property="imgPath" styleId="icon" style="width:250px;display:none" styleClass="validate[] iptClass"></html:text>     	
									<div style="float: left">
										<input type="button" value="上传并预览" onclick="fileClickpad()"/>
									</div>
									<div id="iconDiv" style="float: left;padding-right: 20px">
									  <c:if test="${AdvertisingActionForm.imgPath != null && AdvertisingActionForm.imgPath != '' }">
									  <img src="<%=path%>/${AdvertisingActionForm.imgPath }" style="width: 80px;"/>
								 	</c:if>
									</div>
								</td>
							</tr>
								...
								<td width="35%" align="left" align="left" colspan="3">									 
									<div style=" height:450px; overflow:auto; " >
										 <textarea id="ue_detail" name="content"  style="width: 100%"  class="validate[] iptClass" >${AdvertisingActionForm.content }</textarea> 
									</div>
								</td>
							</tr>
							</tr>
