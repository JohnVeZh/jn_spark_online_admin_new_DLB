...
<!--框架必需end-->
	...
	<script type="text/javascript">
		...
		function doDelsById(id,type) {
			if(id!=""){
				top.Dialog.confirm("您确信要删除吗?",
				   	function() {
				   		listForm.action="SysConfig.do?act=realdelete&id="+id+"&type="+type;
						listForm.submit();
					}
				)
			}
		...
		//添加
		function preAdd(){       
		    listForm.action="SysConfig.do?act=preAdd&type=${type}";
			listForm.submit();
		}
		//修改
		function preUpdate(id) {
			if(id!="" ){
			  listForm.action="SysConfig.do?act=preUpdate&id="+id+"&ue=${ue}";
			  listForm.submit();
			}
		}
	</script>
