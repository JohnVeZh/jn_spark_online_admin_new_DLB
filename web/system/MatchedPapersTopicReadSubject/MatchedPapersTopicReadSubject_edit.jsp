...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/MatchedPapersTopicReadSubject.do?act=update" method="post" id="listForm" >
			<input type="text" name="mptrtId" value="${mptrtId }" style="display: none"/>
			<input type="text" name="id" value="${MatchedPapersTopicReadSubjectActionForm.id }" style="display: none"/>
						...
						<table class="tableStyle" transMode="true" footer="normal" >
							<tr>
								...
								<td width="85%" align="left" colspan="3">
									<input type="text" name="cTitle" class="validate[required] iptClass" style="width: 96%" value="${MatchedPapersTopicReadSubjectActionForm.cTitle }" maxNum="200"/>
							...
							<tr>
								...
								<td width="35%" align="left">
									<input type="text" name="sNumber" class="validate[required] iptClass" inputMode="numberOnly"  watermark="限制输入正整数" value="${MatchedPapersTopicReadSubjectActionForm.sNumber }"/>
									<span class="star">*</span>
								</td>
								<td width="15%" align="right">
									分值：
								...
								<td width="35%" align="left">
									<input type="text" name="score" class="validate[required] iptClass" inputMode="numberOnly"  watermark="限制输入正整数" value="${MatchedPapersTopicReadSubjectActionForm.score }"/>
									<span class="star">*</span>
								</td>
							</tr>
							<tr>
								...
								<td width="85%" align="left" colspan="3">
									 	<textarea  id="cAnalysis" name="cAnalysis" style="width: 100%;"  >${MatchedPapersTopicReadSubjectActionForm.cAnalysis }</textarea> 
								</td>
							</tr>
...
<script language="javascript" type="text/javascript">
	...
	function getTabl(){
   	 ...
   	 if($("#score").val()==''){
   	  ...
   	  listForm.action="business/MatchedPapersTopicReadSubject.do?act=update&arrbills="+arrbills;
	  listForm.submit();
	...
	function delTr(id,ts){
		if(id!=''){
		  $.post("business/MatchedPapersTopicReadSubject.do?act=AjasRealdelete", {id:id},
		   function(data){
		    if(data.succeed='000'){
			     //将所在的行删除
