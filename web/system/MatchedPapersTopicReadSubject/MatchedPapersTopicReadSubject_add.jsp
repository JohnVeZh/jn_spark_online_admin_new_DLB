...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/MatchedPapersTopicReadSubject.do?act=add" method="post" id="listForm" >
						...
						<table class="tableStyle" transMode="true" footer="normal" >
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									<input type="text" name="cTitle" class="validate[required] iptClass" style="width: 96%" maxNum="200"/>
...
<script language="javascript" type="text/javascript">
	...
	function getTabl(){
   	 ...
   	 if($("#score").val()==''){
   	  ...
   	  listForm.action="business/MatchedPapersTopicReadSubject.do?act=add&arrbills="+arrbills;
	  listForm.submit();
