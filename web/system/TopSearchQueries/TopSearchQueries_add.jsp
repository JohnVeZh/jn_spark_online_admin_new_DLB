...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/TopSearchQueries.do?act=add" method="post" id="listForm" >
						...
						<table class="tableStyle" >
							<tr>
								...
								<td width="35%" align="left">
									<input type="text" name="title" class="validate[required] iptClass" />
...
<script language="javascript" type="text/javascript">
	...
	function flush(){
	 listForm.action="business/TopSearchQueries.do?act=add";
	 listForm.submit();
