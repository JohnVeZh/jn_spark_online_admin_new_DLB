...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
 		  ...
 		  <html:form  action="business/TopSearchQueries.do?act=update" method="post" styleId="listForm"  onsubmit="return sub(this)">
			<html:text property="id"  style="display:none"></html:text>  
			<html:text property="countnum" style="width:250px;display:none"></html:text>     	
...
<script language="javascript" type="text/javascript">
	...
	function flush(){
	 listForm.action="business/TopSearchQueries.do?act=update";
	 listForm.submit();
