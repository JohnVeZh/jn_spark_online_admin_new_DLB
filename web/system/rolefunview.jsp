...
<link rel="stylesheet" type="text/css" id="theme"/>
 <!--框架必需end-->
  ...
  <%
    ...
    String orgId = (String)request.getAttribute("orgId"); //角色ID
    String typeid = (String)request.getParameter("typeid"); //角色id所属的角色类型
    Collection nodes =(Collection)request.getAttribute("nodes");
    String funrootid=(String)request.getAttribute("funrootid"); //功能根ID
  %>
  
  <body>
     <form action="/crm/system/sysrole.do?act=saveFun" method="post">
        <input type="hidden" name="roleid" value="<%=roleid%>">
        <input type="hidden" name="orgId" value="<%=orgId%>">
     <table width="90%" border="0" align="center" cellpadding="0"   >    
         <div align="center" class="DataTable_Title">查看角色系统功能权限</div>
         <tr>
           <td width="50%" >
     ...
     <div noWrap style="position: absolute; width:90%px; height:100%px; top: 70px; left: 50px; PADDING-BOTTOM: 5px; PADDING-LEFT: 5px; PADDING-RIGHT: 0px; PADDING-TOP: 5px; overflow:auto;"> 
