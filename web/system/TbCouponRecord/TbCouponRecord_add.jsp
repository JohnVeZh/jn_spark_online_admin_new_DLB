...
<div id="scrollContent">
    ...
    <form name="listForm" action="<%=path%>/business/PreferentialCodeUse.do?act=add" method="post" id="listForm" >
            ...
            <fieldset>
                ...
                <table class="tableStyle" transMode="true" footer="normal">
                    ...
                    <tr>
                        ...
                        <td width="35%">
                            <input type="text" name="pcgId" class="validate[required] iptClass" />
                            <span class="star">* 类型：String 长度:32</span>
                        </td>
                    </tr>
                    <tr>
