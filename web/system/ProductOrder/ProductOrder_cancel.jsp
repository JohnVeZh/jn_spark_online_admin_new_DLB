				...
				<fieldset> 
					<legend>订单基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%" align="left">									 
									<html:text property="consignee" disabled="true" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
								</td>
							</tr>
							<tr>
								<td width="15%"  align="right">
								...
								<td width="35%" align="left">									 
									<html:text property="telephone" disabled="true" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
								</td>
								<td width="15%" align="right">
									邮编：
								</td>
								<td width="35%" align="left">									 
									<html:text property="zipcode" disabled="true" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
								</td>
							</tr>
								<tr>
								<td width="15%" align="right">
								...
								<td width="35%" align="left">									 
									<html:text property="price" disabled="true"  style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
								</td>
								<td width="15%" align="right">
									邮费：
								</td>
								<td width="35%" align="left">									 
									<html:text property="postage" disabled="true" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
								</td>
							</tr>
								<tr>
								<td width="15%" align="right">
								...
								<td width="35%" align="left" colspan="3">									 
									<html:text property="address" disabled="true" style="width:80%" styleClass="validate[required] iptClass"></html:text>     	
								</td>
							</tr>
