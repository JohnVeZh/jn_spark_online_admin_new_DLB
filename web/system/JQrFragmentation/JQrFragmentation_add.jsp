...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/JQrFragmentation.do?act=add" method="post" id="listForm" >
					...
					<legend>基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
							...
							<tr>
								...
								<td width="85%" align="left">
									<input type="text" name="hearUrl" style="width: 95%" class="validate[required] iptClass" />
									<span class="star">*</span>
								</td>
							</tr>
							<tr>
								...
								<td width="85%" align="left">
									<input type="text" name="qrCode" style="width: 95%" class="validate[required] iptClass" />
									<span class="star">*</span>
								</td>
							</tr>
						</table>
