        ...
        <div class="center">
            <div class="left">
                <div class="right" align="left">
                    <span>当前位置：批次添加<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
                </div>
            </div>
        </div>
    </div>
...
<script language="javascript" type="text/javascript">
    ...
    function sub(){
        listForm.action="/business/Batch.do?act=add";
        $('#listForm').ajaxSubmit(function(data){
            var data = eval(data);
            if(data.res){
...
//    function sub() {
        //        $.ajax({
//            type: 'POST',
//            url: '/business/Batch.do?act=addBatch',
