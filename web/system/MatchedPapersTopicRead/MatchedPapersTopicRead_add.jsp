...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/MatchedPapersTopicRead.do?act=add" method="post" id="listForm" >
						...
						<table class="tableStyle" transMode="true" footer="normal">
							...
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									<input type="text" name="rName" class="validate[required] iptClass" style="width: 96%" maxNum="500"/>
								...
								<td width="35%" align="left" colspan="3">
									<div style=" height:450px; overflow:auto;  " >
									 	<textarea  id="rContent" name="rContent" style="width: 98%;position: fixed;"  ></textarea> 
									</div>
								</td>
							</tr>
