...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/JQrT.do?act=add" method="post" id="listForm" >
						...
						<table class="tableStyle" transMode="true" footer="normal">
							<tr>
								...
								<td width="85%" align="left">
									<input type="text" name="textTypeName" style="width: 95%" class="validate[required] iptClass" />
