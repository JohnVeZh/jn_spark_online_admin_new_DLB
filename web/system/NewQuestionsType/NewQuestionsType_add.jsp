...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/NewQuestionsType.do?act=add" method="post" id="listForm" >
			<input type="text" name="parentId" value="${parentId }" style="display: none"/>
			<input type="text" name="levelType" value="${levelType }" style="display: none"/>
					...
					<legend>新题型基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%" align="left">
									<input type="text" name="textTypeName" class="validate[required] iptClass" maxNum="100" />
