...
<%@page import="com.business.v2.word.WordAction.TbWordActionForm"%>
<%
	...
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				...
				<html:form action="business/Word.do?act=WordUpload" styleId="formAction"  method="post" enctype="multipart/form-data" onsubmit="return sub(this)">
