	...
	<div id="scrollContent">
		<div class="position">
			<div class="center">
				<div class="left">
					<div class="right">
					<span>当前位置：新增单词<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
					</div>
				</div>
			</div>
		</div>
		<form name="listForm" action="<%=path %>/business/Word.do?act=add" method="post" id="listForm" >
			...
			<table  class="tableStyle" mode="list" useCheckbox="true" selectRowButtonOnly="false" id="listTable">
				...
				<tr>
					...
					<td width="35%" align="left">
						<input type="text" name="phoneticSymbol" id="phoneticSymbol"/>
					</td>
				</tr>
				<tr>
					<td width="15%" align="right">
					...
					<td  width="35%" align="left" >
						<input type="text" name="pronunciationUrl" id="pronunciationUrl" style="width: 100%" />
					</td>
					<td width="15%" align="right">
						释义：
					</td>
					<td width="35%" align="left">
						<input type="text" name="paraphrase" id="paraphrase" style="width: 100%"/>
					</td>
				</tr>
				<tr>
					<td width="15%" align="right">
					...
					<td width="35%" align="left" colspan="3">
						<div>
							<input  type="text" style="width: 100%" name="exampleSentence" id="exampleSentence" maxNum="500"/>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td width="35%" align="left" colspan="3">
						<div>
							<input  type="text" style="width: 100%" name="exampleReference" id="exampleReference" maxNum="500"/>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td width="35%" align="left" colspan="3">
						<input type="text" name="exampleUrl" id="exampleUrl"/>
					</td>
				</tr>
				<tr>
