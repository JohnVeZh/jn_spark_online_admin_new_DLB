...
<%@page import="com.business.v2.questionWriting.TbQuestionWritingActionForm"%>
<%
	...
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				...
				<html:form action="business/QuestionWriting.do?act=QuestionWritingUpload2" styleId="formAction"  method="post" enctype="multipart/form-data" onsubmit="return sub(this)">
