	...
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				...
				<html:form action="business/QuestionWriting.do?act=QuestionWritingUpload" styleId="formAction"  method="post" enctype="multipart/form-data" onsubmit="return sub(this)">
