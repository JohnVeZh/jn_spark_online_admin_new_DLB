...
%>
  ...
  if (document.getElementById) { 
	<%
	    StringBuffer tree=treeMaker.TreeRootInit3(rootid,"类别管理",request.getContextPath()+"/style/normal/images/tree01.gif",request.getContextPath()+"/style/normal/images/tree01.gif","javascript:window.location.reload()","main");
