...
<link rel="stylesheet" type="text/css" id="theme"/>
 <!--3.3框架必需end-->
	...
	<script type="text/javascript">
        ...
        function submitForm() {
			listForm.action="TbQuestionReading.do?act=addOption"
			listForm.submit();
        }
					...
					<table class="tableStyle" transMode="true" footer="normal">
						<tr>
							...
							<td width="85%" align="left" colspan="2">
								<input type="text" name="prefix" id="title" style="width: 20%" placeholder="单个大写英文字幕" style="text-transform:uppercase;" />
						...
						<tr>
							...
							<td width="85%" align="left" colspan="2">
								...
								<textarea rows="1" cols="1" style="width: 70%" name="content" ></textarea>
							</td>
						</tr>
						<tr>
							<td width="15%" align="right">
