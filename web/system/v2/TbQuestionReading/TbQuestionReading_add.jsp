...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="<%=path%>/business/TbQuestionReading.do?act=add" method="post" id="listForm" >
						...
						<c:choose>
							<c:when test="${textName=='阅读原文' }">
								<div name="阅读原文" id="listening" style="width:100%;min-height: 450px">
									<input type="text" name="readingId" style="display: none"/>
									<div style="min-height: 450px">
										<h3>文本内容</h3>
										<textarea  id="ue_wContent" name="content" style="width: 100%;min-height: 450px"  ></textarea>
									</div>
								</div>
							</c:when>
