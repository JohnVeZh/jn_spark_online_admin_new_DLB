...
<div id="scrollContent">
	...
	<form name="listForm" action="${pageContext.request.contextPath}/business/TbQuestionListening.do?act=update" method="post" id="listForm" onsubmit="return sub(this)" target="main" >
		<input type="hidden" name="id" value="${TbSpecialCatalogActionForm.id }" style="display: none"/>
				...
				<table class="tableStyle" transMode="true" footer="normal">
					<tr>
						...
						<td width="85%" align="left" >
							<input type="text" name="name" id="name" class="validate[] iptClass" style="width: 95%" value="${TbSpecialCatalogActionForm.name }" maxNum="500" />
					...
					<tr>
						...
						<td width="85%" align="left">
							<input type="text" name="audioUrl" id="audioUrl" class="validate[] iptClass" style="width: 70%" value="${TbQuestionListeningActionForm.audioUrl }"/>
							<audio style="width: 15%;" controls="controls"><source src="http://7xqc0j.com1.z0.glb.clouddn.com/spark-exam/spark-exam/${TbQuestionListeningActionForm.audioUrl }" /></audio>
						</td>
					</tr>
					<tr>
						<td width="10%" align="right">
					...
					<tr>
						...
						<td width="85%" align="left">
							...
							<textarea rows="1" cols="1" style="width: 80%" name="title" id="title" >${TbQuestionListeningActionForm.title }</textarea>
						</td>
					</tr>
				</table>
				<br/>
				<div class="basicTab">
					...
					<div name="听力原文" id="listening" style="width:100%;min-height: 450px">
						...
						<div style="min-height: 450px">
							<h3>文本内容</h3>
							<textarea  id="ue_wContent" name="tapescripts" style="width: 100%;min-height: 450px"  >${TbQuestionListeningActionForm.tapescripts }</textarea>
						</div>
					</div>
					</c:when>
					...
					<div name="翻译" id="translate" style="width:100%;min-height: 450px" >
						...
						<div style="min-height: 450px">
							<h3>文本内容</h3>
							<textarea  id="ue_wTest" name="translation" style="width: 100%;min-height: 450px"  >${TbQuestionListeningActionForm.translation }</textarea>
						</div>
					</div>
					</c:when>
					<c:otherwise>
