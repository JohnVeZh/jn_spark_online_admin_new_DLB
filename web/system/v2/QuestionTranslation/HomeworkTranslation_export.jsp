...
<%@page import="com.business.v2.questionTranslation.TbQuestionTranslationActionForm"%>
<%
		...
		<div class="center">
			<div class="left">
				<div class="right" align="left">
					<span>当前位置：批量导入<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
				<div style="" align="center">
				<html:form action="business/QuestionTranslation.do?act=QuestionTranslationUpload2" styleId="formAction"  method="post" enctype="multipart/form-data" onsubmit="return sub(this)">
