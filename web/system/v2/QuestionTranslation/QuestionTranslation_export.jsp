	...
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				...
				<html:form action="business/QuestionTranslation.do?act=QuestionTranslationUpload" styleId="formAction"  method="post" enctype="multipart/form-data" onsubmit="return sub(this)">
