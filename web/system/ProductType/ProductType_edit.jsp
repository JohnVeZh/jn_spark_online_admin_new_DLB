		...
		<div class="center">
			<div class="left">
				<div class="right" align="left">
					<span>当前位置：新增产品类型<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
 		  <html:form  action="business/ProductType.do?act=update" method="post" enctype="multipart/form-data"  onsubmit="return sub(this)">
			...
			<html:text style="display:none" property="parentId" ></html:text> 
					...
					<legend>产品类型基本信息</legend> 
						<table class="tableStyle" >
								...
								<td width="35%" align="left">									 
									<html:text property="typeName" style="width:250px" styleClass="validate[required] iptClass" maxlength="15"></html:text>     	
								...
								<td width="35%" align="left">									 
									<html:text property="sort" style="width:250px" styleClass="validate[required,length[0,4],custom[onlyNumber]] iptClass" onkeypress="return (/[\d]/.test(String.fromCharCode(event.keyCode)))"></html:text>     	
									<span class="star">*</span>
								</td>
							</tr>
							<%--<tr>
							 <td width="15%" align="right">
								...
								<td width="35%" align="left" >									 
									<html:text property="imgPhone" styleId="iconPhone" readonly="true" style="width:250px;display:none" styleClass="validate[] iptClass"></html:text>     	
								...
								<td width="35%" align="left">									 
									<html:text property="imgPad" styleId="iconPad" readonly="true" style="width:250px;display:none" styleClass="validate[] iptClass"></html:text>     	
									<div style="float: left;">
