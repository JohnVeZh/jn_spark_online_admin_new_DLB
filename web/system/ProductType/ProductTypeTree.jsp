...
%>
  ...
  if (document.getElementById) { 
	<%
	    StringBuffer tree=treeMaker.TreeRootInit3(rootid,"类型管理",request.getContextPath()+"/style/normal/images/tree01.gif",request.getContextPath()+"/style/normal/images/tree01.gif","ProductType.do?act=list","main");
