...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="System/SysConfig.do?act=add" method="post" id="listForm" >
			<input type="text" name="type" value="${type }" class="validate[required] iptClass" style="display: none"/>
						...
						<table class="tableStyle" transMode="true" footer="normal">
							...
							<tr style="display: none">
								...
								<td width="35%" align="left" colspan="3">
									<input type="text" name="alias" value="${type }" class="validate[required] iptClass" />
									<span class="star">*</span>
								</td>
							</tr>
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									<textarea id="ue_content" name="value" style="width: 100%;height: 80px"  class="validate[] iptClass" ></textarea> 
								</td>
							</tr>
