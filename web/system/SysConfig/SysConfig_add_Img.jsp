...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="System/SysConfig.do?act=add" method="post" id="listForm" onsubmit="javascript:return checkForm();">
			<input type="text" name="type" id="type" value="${type }" class="validate[required] iptClass" style="display: none"/>
			<input type="text" name="modular" value="${modular }" class="validate[required] iptClass" style="display: none"/>
						...
						<table class="tableStyle" >
							<c:if test="${type=='NEWS_CAROUSEL3' || type=='INDEX_CAROUSEL3' || type=='START_CAROUSEL'}">
								<tr>
									...
									<td width="90%" align="left" colspan="3">
										<select id="jumpType" name="jumpType" onchange="javascript:cleanResource();">
											<option value="01">自有内容（富文本）</option>
											<option value="02">外部链接（链接地址）</option>
											<option value="11">社区资讯</option>
											<option value="12">社区活动</option>
											<option value="13">图书</option>
											<option value="14">网课</option>
										</select>
								...
								<tr>
									...
									<td width="90%" align="left" colspan="3">
										<input type="hidden" id="valueId" name="valueId" watermark="请输入链接地址，以http://开头"/>
										<input type="text" id="valueName" name="valueName" watermark="请输选择资源名称" style="width:70%; cursor:pointer;" readonly="readonly" onclick="javascript:selectResource();"/>
							...
							<tr>
								...
								<td width="90%" align="left" colspan="3">
									<input type="text" name="alias" id="alias" class="validate[] iptClass" style="width:70%;"/>
							...
							<tr>
								...
								<td width="90%" align="left" colspan="3">
									<input type="text" name="name" class="validate[required] iptClass" maxlength="200" style="width:70%;"/>
							...
							<c:if test="${type=='INDEX_CAROUSEL' || type=='NEWS_CAROUSEL' || type=='NEWS_CAROUSEL3' || type=='INDEX_CAROUSEL2' || type=='INDEX_CAROUSEL3' || type=='START_CAROUSEL'}">
								<tr>
									...
									<td width="90%" align="left" colspan="3">
										<input type="text" id="url" name="url" watermark="请输入链接地址" style="width:70%;"/>
									</td>
								</tr>
							</c:if>
							<c:choose>
				    		  ...
				    		  <c:otherwise>
								<tr>
									...
									<div style=" height:450px; overflow:auto; " >
										<textarea id="ue_content"  name="value" style="width: 98%;height: 80px" ></textarea>
									</div>
									</td>
								</tr>
				    		  </c:otherwise>
...
<script language="javascript" type="text/javascript">
	...
	function back(){
	  ...
	  $(function(){
			UE.getEditor('ue_content', {initialFrameWidth:'100%',initialFrameHeight : 350});
