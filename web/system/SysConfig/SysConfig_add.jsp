...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：sys_config_add<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
		<form name="listForm" action="business/SysConfig.do?act=add" method="post" id="listForm" >
				...
				<fieldset> 
					<legend>sys_config基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%">
									<input type="text" name="alias" class="validate[required] iptClass" />
								...
								<td width="35%">
									<input type="text" name="value" class="validate[required] iptClass" />
