...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/JQrMpths.do?act=add" method="post" id="listForm" >
			<input type="text" name="qrmpthtId" value="${mpthtId }" style="display: none"/>
...
<script language="javascript" type="text/javascript">
	...
	function getTabl(){
	   ...
	   $("#listForm").attr("action","business/JQrMpths.do?act=add&arrbills="+arrbills);	  
