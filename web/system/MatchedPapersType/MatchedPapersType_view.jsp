...
<%@page import="com.business.MatchedPapersType.MatchedPapersTypeActionForm"%>
<%
...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：matched_papers_type_view<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
 		  <html:form  action="business/MatchedPapersType.do?act=update" method="post"  onsubmit="return sub(this)">
			<div class="box1 center" whiteBg="true" id="form1">
				<fieldset> 
					<legend>matched_papers_type基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%">									 
									<html:text property="textTypeName" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
