...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/MatchedPapersType.do?act=add" method="post" id="listForm" >
			<input type="text" name="parentId" value="${parentId }" style="display: none"/>
			<input type="text" name="scId" value="${scId }" style="display: none"/>
					...
					<legend>基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%" align="left">
									<input type="text" name="textTypeName" style="width: 90%" class="validate[required] iptClass" maxNum="100" />
