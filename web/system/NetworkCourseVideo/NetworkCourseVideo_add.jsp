...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/NetworkCourseVideo.do?act=add" method="post" id="listForm" >
						...
						<table class="tableStyle" transMode="true" footer="normal">
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									<input type="text" name="ncvName" id="ncvName" class="validate[required] iptClass" style="width: 96%"/>
								</td>
							</th>
							<tr>
								<td width="15%" align="right">
							...
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									<input type="radio" name="ncvType" id="ncvType" value="1"  checked="checked" onclick="ntChk(1)" />直播
									<input type="radio" name="ncvType" id="ncvType" value="0" onclick="ntChk(0)"/>录播
								</td>
							</tr>
							<tr>
								<td width="15%" align="right">
								...
								<td width="35%" align="left">
									<input type="text" name="ncvDuration" id="ncvDuration" class="validate[required] iptClass" />
								</td>
								<td width="15%" align="right">
									<span class="star">*</span>开课时间：
								</td>
								<td width="35%" align="left">
									<input type="text" name="ncvStartTimes" id="ncvStartTimes" class="date" dateFmt="yyyy-MM-dd HH:mm:ss"/>
								</td>
							</tr>
							<tr>
								<td width="15%" align="right">
								...
								<td width="35%" align="left">
									cc视频路径:<br /><input type="text" name="ncvPreviewLink" class="validate[] iptClass" style="width:80%"/>
								...
								<td width="35%" align="left" >
								 图片路径：<input type="text" style="width: 100%" name="ncvImg" id="iconPhone" class="validate[] iptClass" /><br/>
							...
							<tr>
								...
								<td width="35%" align="left">
									<input type="text" name="ncvRecordLinkId" class="validate[] iptClass" style="width: 96%"/>
									<span class="star"></span>
								</td>
								<td width="15%" align="right">
									课程链接：
								...
								<td width="35%" align="left">
									<input type="text" name="ncvLiveLink" class="validate[] iptClass" style="width: 96%"/>
									<span class="star"></span>
								</td>
							</tr>
							<tr>
								...
								<td width="85%" align="left">
									<input type="text" name="sort" id="sort" class="validate[] iptClass"  inputMode="numberOnly"  watermark="限制输入正整数"/>
									<span class="star"></span>
								</td>
								<td width="15%" align="right">
									直播间ID：
								...
								<td width="85%" align="left">
									<input type="text" name="ncvLiveRoomId" id="ncvLiveRoomId" class="validate[] iptClass"/>
									<span class="star"></span>
								</td>
							</tr>
						</table>
...
<script language="javascript" type="text/javascript">
	...
	function flush(){
	   ...
	   listForm.action="business/NetworkCourseVideo.do?act=add";
	   listForm.submit();
	}
