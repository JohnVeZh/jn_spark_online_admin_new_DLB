...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/JQrMptht.do?act=add" method="post" id="listForm" >
			<input type="text" name="qrmpthId" style="display: none" value="${mpthId }" />
						...
						<table class="tableStyle" transMode="true" footer="normal">
							<tr>
								...
								<td width="85%" colspan="3" align="left">
									<input type="text" name="url" class="validate[required] iptClass" style="width: 96%"/>
									<span class="star">*</span>
								</td>
							</tr>
								<tr>
