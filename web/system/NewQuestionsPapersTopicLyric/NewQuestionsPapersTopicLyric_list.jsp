...
<%@page import="com.business.NewQuestionsPapersTopicLyric.NewQuestionsPapersTopicLyric"%>
<%
...
<link rel="stylesheet" type="text/css" id="theme"/>
 <!--3.3框架必需end-->
	...
	<script type="text/javascript">
		...
		function doDels() {
			...
			if(idVal!=""){
				top.Dialog.confirm("您确信要删除吗?",
				   	function() {
				   		listForm.action="NewQuestionsPapersTopicLyric.do?act=realdelete"+idVal;
						listForm.submit();
					}
				)
			}
		...
		//添加
		function preAdd(){       
		    listForm.action="NewQuestionsPapersTopicLyric.do?act=preAdd"
			listForm.submit();
		}
		//修改
		function preUpdate(j) {
			var idVal = isSel();
			if(idVal!=""){
			  listForm.action="NewQuestionsPapersTopicLyric.do?act=preUpdate"+idVal;
			  listForm.submit();
			}
		}
		//详情
		function view() {
			var idVal = isSel();
			if(idVal!=""){
		  	   listForm.action="NewQuestionsPapersTopicLyric.do?act=view"+idVal;
		  		listForm.submit();
			}
		}
		//清空查询数据
	...
	<div id="scrollContent">
		<div class="position">
			<div class="center">
				<div class="left">
					<div class="right">
					<span>当前位置：new_questions_papers_topic_lyric_list<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
					</div>
				</div>
			</div>
		</div>
		<form name="listForm" scope="request" action="<%=path%>/business/NewQuestionsPapersTopicLyric.do?act=list" method="post">
			...
			<table  class="tableStyle" mode="list" useCheckbox="true" selectRowButtonOnly="false" id="listTable">
					...
					<tr >
						<th width="3%" height="25" align="center" class="DataTable_Field">
								...
								<th height="25"  align="center" class="DataTable_Field" title="新题型听力-真题ID * 类型：String 长度:32">nqptid</th>								 
	...
	{
		po = (NewQuestionsPapersTopicLyric)list.get(i);
%>
	<tr  >
