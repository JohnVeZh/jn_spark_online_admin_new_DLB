...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：push_log_edit<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
				...
				<fieldset> 
					<legend>push_log基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%">									 
									<html:text property="editcontent" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
								...
								<td width="35%">									 
									<html:text property="ismap" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
