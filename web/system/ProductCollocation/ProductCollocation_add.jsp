...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：product_collocation_add<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
		<form name="listForm" action="business/ProductCollocation.do?act=add" method="post" id="listForm" >
				...
				<fieldset> 
					<legend>product_collocation基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%">
									<input type="text" name="productFtype" class="validate[required] iptClass" />
								...
								<td width="35%">
									<input type="text" name="productFid" class="validate[required] iptClass" />
								...
								<td width="35%">
									<input type="text" name="productType" class="validate[required] iptClass" />
									<span class="star">* 类型：int 长度:10</span>
								</td>
							</tr>
								<tr>
