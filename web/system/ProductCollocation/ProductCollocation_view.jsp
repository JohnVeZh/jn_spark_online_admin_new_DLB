...
<%@page import="com.business.ProductCollocation.ProductCollocationActionForm"%>
<%
...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：product_collocation_view<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
 		  <html:form  action="business/ProductCollocation.do?act=update" method="post"  onsubmit="return sub(this)">
			<div class="box1 center" whiteBg="true" id="form1">
				<fieldset> 
					<legend>product_collocation基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%">									 
									<html:text property="productFtype" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
								...
								<td width="35%">									 
									<html:text property="productFid" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
								...
								<td width="35%">									 
									<html:text property="productType" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
									<span class="star"><!--* 类型：int 长度:10--></span>
								</td>
							</tr>
								<tr>
