		...
		<div class="center">
			<div class="left">
				<div class="right" align="left">
					<span>当前位置：web_config_view<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
					...
					<legend>web_config基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%" align="left">
								   ${WebConfigActionForm.configName }									 
								</td>
								<td width="15%" align="right">
									创建时间：
								</td>
								<td width="35%" align="left">	
								    ${WebConfigActionForm.opetime }									 
								</td>
							</tr>
								<tr>
								<td width="15%" align="right">
								...
								<td width="35%" align="left">
								    ${WebConfigActionForm.type }										 
								</td>
								<td width="15%" align="right">
									内容：
								</td>
								<td width="35%" align="left">	
								    ${WebConfigActionForm.configContent }									 
								</td>
							</tr>
						</table>
					</fieldset>
