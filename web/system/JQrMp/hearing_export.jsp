		...
		<div class="center">
			<div class="left">
				<div class="right" align="left">
					<span>当前位置：听力上传<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
				<div style="" align="center">
				<html:form action="business/JQrMp.do?act=getUpload_hearing" styleId="formAction"  method="post" enctype="multipart/form-data" onsubmit="return sub(this)">
					<input type="text" name="mptId" value="${mptId }" style="display: none"/>
