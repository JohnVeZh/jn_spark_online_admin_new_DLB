...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/JQrMp.do?act=add" method="post" id="listForm" >
						...
						<table class="tableStyle" transMode="true" footer="normal">
							...
							<tr>
								...
								<td width="85%" align="left">
									<input type="text" name="mpName" class="validate[required] iptClass" />
							...
							<tr>
								...
								<td width="35%" align="left" >
									<input type="text" name="url" style="width: 95%" class="validate[required] iptClass" />
									<span class="star">*</span>
								</td>
							</tr>
							<tr>
