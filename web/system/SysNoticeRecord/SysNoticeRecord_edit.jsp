...
<%@page import="com.business.SysNoticeRecord.SysNoticeRecordActionForm"%>
<%
...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：sys_notice_Record_edit<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
 		  <html:form  action="business/SysNoticeRecord.do?act=update" method="post"  onsubmit="return sub(this)">
				...
				<fieldset> 
					<legend>sys_notice_Record基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%">									 
									<html:text property="sysNoticeId" style="width:250px" styleClass="validate[required] iptClass"></html:text>     	
									<span class="star">* 类型：String 长度:32</span>
								</td>
							</tr>
						</table>
