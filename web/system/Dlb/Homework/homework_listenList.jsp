...
<div id="scrollContent">
    <div class="position">
        <div class="center">
            <div class="left">
                <div class="right">
                    <span>当前位置：网课列表>>作业列表>>听力题目列表<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
                </div>
            </div>
        </div>
    </div>
    <form name="listForm" scope="request" action="<%=path%>/business/Dlb/HomeworkQuestion.do?act=listenList" method="post" >
        ...
        <table  class="tableStyle" mode="list" useCheckbox="true" selectRowButtonOnly="false" id="listTable">
            ...
            <tr >
                ...
                <th height="25" width="30" align="center" class="DataTable_Field" title="音频地址">音频地址</th>
            ...
            <tr  >
                ...
                <td class="DataTable_Content" align="left" title="<%= obj[5] %>"><%= obj[5] %></td>
                ...
                <td>
                   <%-- <a href="javascript:;" onclick="matchSubject('<%=obj[2].toString()%>')" title="配题">
