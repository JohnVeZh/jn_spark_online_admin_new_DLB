		...
		<div class="position">
			<div class="center">
				<div class="left">
					...
					<span>当前位置：试卷翻译列表<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
					</div>
				</div>
			</div>
		</div>
		<form name="listForm" scope="request" action="" method="post">
			...
			<table  class="tableStyle" mode="list" useCheckbox="true" selectRowButtonOnly="false" id="listTable">
				...
				%>
					<tr>
						<td align="center">
                            <input type="checkbox" name="id" id="id" value="<%=obj[0]%>" onclick="event.cancelBubble=true;">
                            <input type="checkbox" name="name" id="name" value="<%=obj[1]%>" style="display: none">
                        </td>
						<td align="center"><%=++sn%></td>
						<td class="DataTable_Content" align="left" title="<%=obj[1]%>"><%=obj[1]%></td>
						<td class="DataTable_Content" align="left" title=""><%=obj[8]%></td>
						<td>
                            <a href="javascript:;" title="配套绑定"
                               onclick="subAdd('<%=obj[0]%>','<%=obj[1]%>')" > <span class="img_add"></span>
                            </a>
							<%--<a href="javascript:;" onclick="matchSubject('<%=obj[0]%>')" title="配题">
								<span class="img_txt"></span>
							</a>
							<a href="javascript:;" onclick="preUpdate('<%=obj[0]%>')" title="修改">
								<span class="img_edit"></span>
							</a>
							<a id="del_mfp" href="javascript:;" title="删除" onclick="doDelById('<%=obj[0]%>')">
