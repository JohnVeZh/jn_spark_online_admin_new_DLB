		...
		<div class="position">
			<div class="center">
				<div class="left">
					...
					<span>当前位置：试卷听力列表<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
					</div>
				</div>
			</div>
		</div>
		<form name="listForm" scope="request" action="" method="post">
			...
			<table  class="tableStyle" mode="list" useCheckbox="true" selectRowButtonOnly="false" id="listTable">
				<tr >
					...
					<th height="25" width="25" align="center" class="DataTable_Field" title="音频地址">音频地址</th>
				...
				<c:forEach items="${dlbList}" var="l" varStatus="s">
					<tr>
						...
						<td class="DataTable_Content" align="left" title="${l.audioUrl}">${l.audioUrl}</td>
