		...
		<div class="center">
			<div class="left">
				<div class="right" align="left">
					<span>当前位置：网课列表>>作业列表>>添加作业<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
		<form name="listForm" action="<%=path%>/business/Dlb/Homework.do?act=add" method="post" id="listForm" target="frmright" onsubmit="javascript:return checkForm();">
				...
				<fieldset>
					...
					<table class="tableStyle" transMode="true" footer="normal">
						<tr>
							...
							<td width="90%" align="left" >
                                ...
                                <input type="radio" disabled="disabled"
                                    <c:if test="${networkCourse.ncLevel.equals('cet4')}">
                                        checked="checked"
                                    </c:if>
                                />四级
                                <input type="radio" disabled="disabled"
                                    <c:if test="${networkCourse.ncLevel.equals('cet6')}">
                                        checked="checked"
                                    </c:if>
                                />六级
							</td>
						<tr>
							...
							<td width="90%" align="left" >
                                <c:if test="${homework == null}">
                                    <input checked="true" type="radio" name="questionType" value="1" />听力
                                </c:if>
                                <c:if test="${homework != null}">
                       ...
                       <%-- <tr>
                            ...
                            <td width="90%" align="left" >
                                <a href="javascript:;" onclick="preSub()" title="新增"> <span
                                        class="img_add"></span>
                                </a>
						...
						<tr>
							...
							<td width="90%" align="left" colspan="3">
								<span name="vlSpan" id="vlSpan">${networkCourse.ncName }>>${networkCourseVideo.ncvName}</span>
							</td>
						</tr>
					</table>
					<br/>
...
<script language="javascript" type="text/javascript">
    ...
    //选择听力作业题目
    function preSub(){
            top.Dialog.open({URL:"<%=path%>/business/Dlb/HomeworkQuestion.do?act=listenList",Title:"绑定窗口",Width:1024,Height:768});
    }
