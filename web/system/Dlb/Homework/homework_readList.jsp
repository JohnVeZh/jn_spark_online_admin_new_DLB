...
//        top.Dialog.open({URL:"/business/Dlb/HomeworkQuestion.do?act=preUpdate&id="+id,ID:"a1",Width:500,Height:150,Title:"修改作业"});
    ...
    function matchSubject(id) {
        if(id!=""){
            top.Dialog.open({URL:"<%=path%>/business/TbQuestionReading.do?act=matchSubject&catalogId="+id,ID:"a2",Width:1024,Height:768,Title:"查看"});
        }
    }
...
<div id="scrollContent">
    <div class="position">
        <div class="center">
            <div class="left">
                <div class="right">
                    <span>当前位置：网课列表>>作业列表>>阅读题目列表<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
                </div>
            </div>
        </div>
    </div>
