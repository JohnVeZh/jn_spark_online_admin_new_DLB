...
<script type="text/javascript" src="<%=path%>/ueditor/ueditor.all.min.js"></script>
 ...
 <script type="application/javascript">
	 $(function () {
		 ...
		 $("#listForm").attr("action", "/business/Dlb/message.do?act=add&a="+Math.random());

		// alert("title:--form:"+$("input[name=title]").val()+",${title}");
     })
...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="/business/Dlb/message.do?act=add" method="post" id="listForm" target="frmright" >
						...
						<table class="tableStyle" transMode="true" footer="normal">
							...
							<tr>
								...
								<td width="40%" align="left">
									<input type="text" name="title" value="${title}" class="validate[required] iptClass" required="required" />
									<span class="star"></span>
								</td>
								...
								<td width="40%" align="left">
									<input type="text" name="intro" class="validate[required] iptClass" required="required"/>
									<span class="star"></span>
								</td>
							...
							<tr>
								...
								<td width="40%" align="left">
									...
									<select name="jumpType" id="jumpType"  style="z-index: 9999" onchange="changeJumpType()">
										...
										<option value="3" style="z-index: 9999">首页</option>
										<option value="4" style="z-index: 9999">网课-四级</option>
										<option value="5" style="z-index: 9999">网课-六级</option>
										<option value="6" style="z-index: 9999">网课-考研</option>
										<option value="7" style="z-index: 9999">社区-资讯</option>
										<option value="8" style="z-index: 9999">社区-活动</option>
										<option value="9" style="z-index: 9999">图书</option>
										<option value="10" style="z-index: 9999">我的</option>
								...
								<td width="40%" align="left" id="contentIdTd">
							...
							<tr>
								...
								<td width="40%" align="left">
									<input type="text" style="display: none" name="img" id="img" class="validate[] iptClass" value=""/>
								...
								<td width="40%" align="left">
									<input placeholder="不填则立即发送" type="text" name="pushTimeStr" id="pushTimeStr" class="date validate[]" dateFmt="yyyy-MM-dd HH:mm:ss" />
								</td>
								...
								<td width="90%" align="left" colspan="3">
									<div style=" height:450px; overflow:auto; ">
										 <textarea  id="ue_introduce" name="content" style="width: 100%"  ></textarea>
									</div>
								</td>
							</tr>
