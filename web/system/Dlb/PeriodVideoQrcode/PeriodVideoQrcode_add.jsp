...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="<%=path%>/business/PeriodVideoQrcode.do?act=add" method="post" id="listForm" target="frmright">
					...
					<div style="overflow:auto;">
						<table class="tableStyle" >
							...
							<tr>
								...
								<td width="35%" align="left" colspan="2">
								<input type="text" style="width: 100%" name="qrcodeContent" id="qrcodeContent" class="validate[] iptClass" style="width:70%;"/><br/>
								</td>
							</tr>
							<tr>
								<td width="15%" align="right" colspan="2">
