...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/PeriodVideoDetail.do?act=add" method="post" id="listForm">
			<input type="hidden" value="${videoQrcodeId}" id="videoQrcodeId" name="videoQrcodeId"/>
					...
					<div style="overflow:auto;">
						<table class="tableStyle" >
							...
							<tr>
								...
								<td width="35%" align="left" colspan="2">
									<input type="text" name="videoCcid" id="videoCcid"/>
								</td>
							</tr>
							<tr>
...
<script language="javascript" type="text/javascript">
	function flush(){
		...
		listForm.action="business/PeriodVideoDetail.do?act=add";
		   listForm.submit();
	}
