	...
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				...
				<html:form action="business/ActivationCode.do?act=mpAnalysis" styleId="formAction"  method="post" enctype="multipart/form-data" onsubmit="return sub(this)">
					<table>
						<tr>
							<td>选择导入学段:&nbsp;&nbsp;</td>
							<td><html:file property="file" styleId="file" ></html:file></td>
						</tr>
						<tr>
						<td>选择导入学段:&nbsp;&nbsp;</td>
...
<script language="javascript" type="text/javascript">
	...
	function ajaxFilephones(){
		var section=$("select option:checked").val();
		if(section==""){
			alert("请选择选段级别");
			return;
		}
