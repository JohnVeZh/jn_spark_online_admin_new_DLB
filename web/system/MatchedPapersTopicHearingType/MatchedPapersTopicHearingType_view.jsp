...
<%@page import="com.business.MatchedPapersTopicHearingType.MatchedPapersTopicHearingTypeActionForm"%>
<%
...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：matched_papers_topic_hearing_type_view<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
 		  <html:form  action="business/MatchedPapersTopicHearingType.do?act=update" method="post"  onsubmit="return sub(this)">
			<div class="box1 center" whiteBg="true" id="form1">
				<fieldset> 
					<legend>matched_papers_topic_hearing_type基本信息</legend> 
