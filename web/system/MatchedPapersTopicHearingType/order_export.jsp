	...
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				...
				<html:form action="business/MatchedPapersTopicHearingType.do?act=orderExl" styleId="formAction"  method="post" enctype="multipart/form-data" onsubmit="return sub(this)">
