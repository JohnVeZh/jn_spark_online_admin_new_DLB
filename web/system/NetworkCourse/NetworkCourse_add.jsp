...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/NetworkCourse.do?act=add" method="post" id="listForm" target="frmright">
					...
					<div style="overflow:auto;">
						<table class="tableStyle" >
							...
							<tr>
								...
								<td width="35%" align="left" >
								 图片路径：<input type="text" style="width: 100%" name=ncLogo id="ncLogo" class="validate[] iptClass" /><br/>
								</td>
								<td width="15%" align="right">
							...
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									 预告ccID：<input type="text" style="width: 98%" name="ncPreviewLink" id="ncPreviewLink" class="validate[] iptClass" /><br/>
								</td>
							</tr>
							<tr>
								<td width="15%" align="right">
							...
							<tr>
								...
								<td width="35%" align="left">
									<input type="radio" id="isTeacher" name="isTeacher"  checked="checked" value="0"/>否
									<input type="radio" id="isTeacher" name="isTeacher"  value="1"/>是
								</td>
							</tr>
							<!-- <tr>
								<td width="15%" align="right">
							...
							<tr>
								...
								<td width="35%" align="left" >
									<input type="text" name="reserveTimes" id="reserveTime" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" />
								</td>
								<td width="15%" align="right">
									<span class="star">*</span>下架时间：
								</td>
								<td width="35%" align="left" >
									<input type="text" name="offShelfTimes" id="offShelfTime" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" />
								</td>
							</tr>
							<tr>
								<td width="15%" align="right">
								...
								<td width="35%" align="left" >
									<input type="text" name="ncLiveTimes" id="ncLiveTime" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" />
								</td>
								<td width="15%" align="right">
									<span class="star">*</span>结课时间：
								</td>
								<td width="35%" align="left" >
									<input type="text" name="ncEndTimes" id="ncEndTime" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" />
								</td>
							</tr>
							<tr>
								<td width="15%" align="right">
								...
								<td width="35%" align="left" >
									<input type="text" name="saleTimes" id="saleTime" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" />
								</td>
								<td width="15%" align="right">
									停售时间：
								</td>
								<td width="35%" align="left" >
									<input type="text" name="saleEndTimes" id="saleEndTime" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" />
								</td>
							</tr>
							<tr>
								<td width="15%" align="right">
							...
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									开始时间：<input type="text" name="limitStartTimes" id="limitStartTime" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" disabled="disabled"/>
									----
									结束时间：<input type="text" name="limitEndTimes" id="limitEndTime" class="date" dateFmt="yyyy-MM-dd HH:mm:ss" disabled/>
								</td>
							</tr>
							<tr>
								<td width="15%" align="right">
...
<script language="javascript" type="text/javascript">
	function flush(){
		...
		if(offShelfTime.replace(/(^\s*)/g, "").length==0){
			top.Dialog.alert("课程下架时间不能为空",285,285);
		    return "";
		}
		if(ncType==1){
