...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：wrong_question_add<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
		<form name="listForm" action="business/WrongQuestion.do?act=add" method="post" id="listForm" >
				...
				<fieldset> 
					<legend>wrong_question基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%">
									<input type="text" name="mpthsId" class="validate[required] iptClass" />
								...
								<td width="35%">
									<input type="text" name="leveltype" class="validate[required] iptClass" />
								...
								<td width="35%">
									<input type="text" name="wqType" class="validate[required] iptClass" />
