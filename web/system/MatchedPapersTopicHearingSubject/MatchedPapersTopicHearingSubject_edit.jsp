...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/MatchedPapersTopicHearingSubject.do?act=update" method="post" id="listForm" >
			<input type="text" name="mpthtId" value="${mpthtId }" style="display: none"/>
			<input type="text" name="id" value="${MatchedPapersTopicHearingSubjectActionForm.id }" style="display: none"/>
						...
						<table class="tableStyle" transMode="true" footer="normal" >
							<tr>
								...
								<td width="35%" align="left">
									<input type="text" name="sNumber" class="validate[required] iptClass" inputMode="numberOnly"  watermark="限制输入正整数" value="${MatchedPapersTopicHearingSubjectActionForm.sNumber }"/>
								...
								<td width="35%" align="left">
									<input type="text" name="score" class="validate[required] iptClass" inputMode="numberOnly"  watermark="限制输入正整数" value="${MatchedPapersTopicHearingSubjectActionForm.score }"/>
									<span class="star">*</span>
								</td>
							</tr>
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									<input type="text" name="url" class="validate[] iptClass"   style="width: 100%" value="${MatchedPapersTopicHearingSubjectActionForm.url }"/>
								</td>
							</tr>
							<tr>
								<td width="15%" align="right">
								...
								<td width="35%" align="left" colspan="3">
									<div style=" height:450px; overflow:auto; " >
									 	<textarea  id="cAnalysis" name="cAnalysis" style="width: 100%;"  >${MatchedPapersTopicHearingSubjectActionForm.cAnalysis }</textarea> 
									</div>
								</td>
							</tr>
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									<div style=" height:450px; overflow:auto; " >
									 	<textarea  id="content" name="content" style="width: 100%;"  >${MatchedPapersTopicHearingSubjectActionForm.content }</textarea> 
...
<script language="javascript" type="text/javascript">
	...
	function getTabl(){
   	 ...
   	 if($("#score").val()==''){
   	  ...
   	  listForm.action="business/MatchedPapersTopicHearingSubject.do?act=update&arrbills="+arrbills;
	  listForm.submit();
	...
	function delTr(id,ts){
		if(id!=''){
		  $.post("business/MatchedPapersTopicHearingSubject.do?act=AjasRealdelete", {id:id},
		   function(data){
		    if(data.succeed='000'){
			     //将所在的行删除
