...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="listForm" action="business/JQrNw.do?act=add" method="post" id="listForm" target="frmright">
			<input type="text" name="qrnwtId" value="${nwtId }" style="display: none"/>
						...
						<table class="tableStyle" >
							<tr>
								...
								<td width="35%" align="left" >
								  <input type="text" style="display: none" name="imgPath" id="iconPhone" class="validate[] iptClass" />
							...
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									<input type="text" name="name" class="validate[required] iptClass" style="width: 98%"  maxNum="100"/>
								</td>
							</tr>
							<tr>
								<!-- <td width="15%" align="right">
								...
								<td width="35%" align="left" class="sl" >
									<input type="text" name="networkRecordLink" style="width: 95%" />
							...
							<!-- <tr>
								...
								<td width="35%" align="left"  class="sz" colspan="3">
									<input type="text" name="networkLiveLink" style="width: 95%" />
									<span class="star">*</span>
								</td>
