...
<body class="ali02">	
	<div id="scrollContent">
		...
		<form name="mpthForm" action="business/JQrMpth.do?act=add" method="post" id="mpthForm" >
		<input type="text" name="qrmpId" style="display: none" value="${mpId }" />
					...
					<legend>基本信息</legend> 
						<table class="tableStyle" transMode="true" footer="normal">
								...
								<td width="35%" align="left">
									<input type="text" name="hName" class="validate[required] iptClass" />
							...
							<tr>
								...
								<td width="35%" align="left" colspan="3">
									<div style="height:420px; overflow:auto; " >
									 	<textarea  id="content" name="hContent" style="width: 100%;"  ></textarea> 
									</div>
								</td>
							</tr>
						</table>
