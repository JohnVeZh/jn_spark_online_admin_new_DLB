		...
		<div noWrap
			...
			<script language="javascript">
			  if (document.getElementById) { 
				<%
				    StringBuffer tree=treeMaker.TreeRootInit3(rootid,"课时管理",request.getContextPath()+"/style/normal/images/tree01.gif",request.getContextPath()+"/style/normal/images/tree01.gif","javascript:window.location.reload()","main");
