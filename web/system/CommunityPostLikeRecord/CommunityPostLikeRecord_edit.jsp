...
<%@page import="com.business.CommunityPostLikeRecord.CommunityPostLikeRecordActionForm"%>
<%
...
<body class="ali02">	
	<div id="scrollContent">
		...
		<div class="center">
			<div class="left">
				<div class="right">
					<span>当前位置：community_post_like_record_edit<!--< % out.write( MenuMgr.getMenuNavigation("402890e31094bb9c011094c692ea0003"));%>--></span>
				</div>
			</div>
		</div>
	</div> 
 		  <html:form  action="business/CommunityPostLikeRecord.do?act=update" method="post"  onsubmit="return sub(this)">
			<html:hidden property="id" ></html:text>  
			<div class="box1 center" whiteBg="true" id="form1">
				<fieldset> 
					<legend>community_post_like_record基本信息</legend> 
