...
FitWindow		: "Maksimeeri redaktori m??tmed",
ShowBlocks		: "N?ita blokke",
...
CheckboxProp		: "M?rkeruudu omadused",
...
// Alerts and Messages
ProcessingXHTML		: "T??tlen XHTML'i. Palun oota...",
Done				: "Tehtud",
PasteWordConfirm	: "Tekst, mida soovid lisada paistab p?rinevat Word'ist. Kas soovid seda enne kleepimist puhastada?",
NotCompatiblePaste	: "See k?sk on saadaval ainult Internet Explorer versioon 5.5 v?i uuema puhul. Kas soovid kleepida ilma puhastamata?",
UnknownToolbarItem	: "Tundmatu t??riistarea üksus \"%1\"",
UnknownCommand		: "Tundmatu k?sunimi \"%1\"",
NotImplemented		: "K?sku ei t?idetud",
UnknownToolbarSet	: "T??riistariba \"%1\" ei eksisteeri",
NoActiveX			: "Sinu veebisirvija turvalisuse seaded v?ivad limiteerida m?ningaid tekstirdaktori kasutusv?imalusi. Sa peaksid v?imaldama valiku \"Run ActiveX controls and plug-ins\" oma veebisirvija seadetes. Muidu v?id sa t?heldada vigu tekstiredaktori t??s ja m?rgata puuduvaid funktsioone.",
BrowseServerBlocked : "Ressursside sirvija avamine eba?nnestus. V?imalda pop-up akende avanemine.",
DialogBlocked		: "Ei olenud v?imalik avada dialoogi akent. V?imalda pop-up akende avanemine.",
...
DlgGenLinkCharset	: "Lingitud ressurssi m?rgistik",
DlgGenStyle			: "Laad",
...
DlgFlashChkMenu		: "V?imalda flash menüü",
DlgFlashScale		: "Mastaap",
DlgFlashScaleAll	: "N?ita k?ike",
DlgFlashScaleNoBorder	: "??rist ei ole",
DlgFlashScaleFit	: "T?pne sobivus",
...
DlgLnkTargetFrameName	: "Sihtm?rk raami nimi",
...
DlnLnkMsgInvPopName	: "Hüpikakna nimi peab algama alfabeetilise t?hega ja ei tohi sisaldada tühikuid",
...
DlgReplaceCaseChk		: "Erista suur- ja v?iket?hti",
DlgReplaceReplaceBtn	: "Asenda",
DlgReplaceReplAllBtn	: "Asenda k?ik",
DlgReplaceWordChk		: "Otsi terviklike s?nu",

// Paste Operations / Dialog
PasteErrorCut	: "Sinu veebisirvija turvaseaded ei luba redaktoril automaatselt l?igata. Palun kasutage selleks klaviatuuri klahvikombinatsiooni (Ctrl+X).",
...
DlgPasteMsg2	: "Palun kleebi j?rgnevasse kasti kasutades klaviatuuri klahvikombinatsiooni (<STRONG>Ctrl+V</STRONG>) ja vajuta seej?rel <STRONG>OK</STRONG>.",
DlgPasteSec		: "Sinu veebisirvija turvaseadete t?ttu, ei oma redaktor otsest ligip??su l?ikelaua andmetele. Sa pead kleepima need uuesti siia aknasse.",
...
DlgSpellNotInDic		: "Puudub s?nastikust",
DlgSpellChangeTo		: "Muuda",
DlgSpellBtnIgnore		: "Ignoreeri",
DlgSpellBtnIgnoreAll	: "Ignoreeri k?iki",
DlgSpellBtnReplace		: "Asenda",
DlgSpellBtnReplaceAll	: "Asenda k?ik",
DlgSpellBtnUndo			: "V?ta tagasi",
...
DlgSpellNoChanges		: "?igekirja kontroll sooritatud: ühtegi s?na ei muudetud",
DlgSpellOneChange		: "?igekirja kontroll sooritatud: üks s?na muudeti",
DlgSpellManyChanges		: "?igekirja kontroll sooritatud: %1 s?na muudetud",

IeSpellDownload			: "?igekirja kontrollija ei ole installeeritud. Soovid sa selle alla laadida?",

// Button Dialog
DlgButtonText		: "Tekst (v??rtus)",
DlgButtonType		: "Tüüp",
...
// Select Field Dialog
DlgSelectName		: "Nimi",
DlgSelectValue		: "V??rtus",
DlgSelectSize		: "Suurus",
DlgSelectLines		: "ridu",
DlgSelectChkMulti	: "V?imalda mitu valikut",
DlgSelectOpAvail	: "V?imalikud valikud",
DlgSelectOpText		: "Tekst",
DlgSelectOpValue	: "V??rtus",
...
DlgTextName			: "Nimi",
DlgTextValue		: "V??rtus",
DlgTextCharWidth	: "Laius (t?hem?rkides)",
DlgTextMaxChars		: "Maksimaalselt t?hem?rke",
DlgTextType			: "Tüüp",
...
// Hidden Field Dialog
DlgHiddenName	: "Nimi",
DlgHiddenValue	: "V??rtus",

// Bulleted List Dialog
BulletedListProp	: "T?pitud loetelu omadused",
...
DlgLstTypeLCase		: "V?iket?hed (a, b, c)",
DlgLstTypeUCase		: "Suurt?hed (A, B, C)",
DlgLstTypeSRoman	: "V?iksed Rooma numbrid (i, ii, iii)",
DlgLstTypeLRoman	: "Suured Rooma numbrid (I, II, III)",

// Document Properties Dialog
DlgDocGeneralTab	: "üldine",
DlgDocBackTab		: "Taust",
DlgDocColorsTab		: "V?rvid ja veerised",
...
DlgDocCharSet		: "M?rgistiku kodeering",
...
DlgDocCharSetWE		: "L??ne-Euroopa",
DlgDocCharSetOther	: "ülej??nud m?rgistike kodeeringud",

DlgDocDocType		: "Dokumendi tüüpp?is",
DlgDocDocTypeOther	: "Teised dokumendi tüüpp?ised",
DlgDocIncXHTML		: "Arva kaasa XHTML deklaratsioonid",
DlgDocBgColor		: "Taustav?rv",
...
DlgDocMargins		: "Lehekülje ??rised",
DlgDocMaTop			: "ülaserv",
DlgDocMaLeft		: "Vasakserv",
DlgDocMaRight		: "Paremserv",
DlgDocMaBottom		: "Alaserv",
DlgDocMeIndex		: "Dokumendi v?tmes?nad (eraldatud komadega)",
DlgDocMeDescr		: "Dokumendi kirjeldus",
DlgDocMeAuthor		: "Autor",
DlgDocMeCopy		: "Autori?igus",
DlgDocPreview		: "Eelvaade",

// Templates Dialog
Templates			: "?abloon",
DlgTemplatesTitle	: "Sisu ?abloonid",
DlgTemplatesSelMsg	: "Palun vali ?abloon, et avada see redaktoris<br />(praegune sisu l?heb kaotsi):",
DlgTemplatesLoading	: "Laen ?abloonide nimekirja. Palun oota...",
DlgTemplatesNoTpl	: "(ühtegi ?ablooni ei ole defineeritud)",
