...
RowCM				: "Wiersz",
ColumnCM			: "Kolumna",
InsertRowAfter		: "Wstaw wiersz poni?ej",
InsertRowBefore		: "Wstaw wiersz powy?ej",
...
InsertCellAfter		: "Wstaw komórk? z prawej",
InsertCellBefore	: "Wstaw komórk? z lewej",
DeleteCells			: "Usuń komórki",
MergeCells			: "Po??cz komórki",
MergeRight			: "Po??cz z komórk? z prawej",
MergeDown			: "Po??cz z komórk? poni?ej",
HorizontalSplitCell	: "Podziel komórk? poziomo",
VerticalSplitCell	: "Podziel komórk? pionowo",
...
CheckboxProp		: "W?a?ciwo?ci pola wyboru (checkbox)",
HiddenFieldProp		: "W?a?ciwo?ci pola ukrytego",
RadioButtonProp		: "W?a?ciwo?ci pola wyboru (radio)",
...
BrowseServerBlocked : "Nie mo?na otworzy? okno menad?era plików. Upewnij si?, ?e wszystkie blokady wyskakuj?cych okienek s? wy??czone.",
DialogBlocked		: "Nie mo?na otworzy? okna dialogowego. Upewnij si?, ?e wszystkie blokady wyskakuj?cych okienek s? wy??czone.",
...
DlgGenLongDescr		: "D?ugi opis hiper??cza",
...
DlnLnkMsgInvPopName	: "Nazwa wyskakuj?cego okienka musi zaczyna? si? od znaku alfanumerycznego i nie mo?e zawiera? spacji",
...
DlgFindAndReplaceTitle	: "Znajd? i zamień",
...
DlgPasteMsg2	: "Prosz? wklei? w poni?szym polu u?ywaj?c klawiaturowego skrótu (<STRONG>Ctrl+V</STRONG>) i klikn?? <STRONG>OK</STRONG>.",
DlgPasteSec		: "Zabezpieczenia przegl?darki uniemo?liwiaj? wklejenie danych bezpo?rednio do edytora. Prosz? dane wklei? ponownie w tym okienku.",
...
DlgDocCharSetCE		: "?rodkowoeuropejskie",
...
DlgDocDocType		: "Nag?ówek typu dokumentu",
...
DlgTemplatesLoading	: "?adowanie listy szablonów. Prosz? czeka?...",
DlgTemplatesNoTpl	: "(Brak zdefiniowanych szablonów)",
DlgTemplatesReplace	: "Zast?p aktualn? zawarto??",
