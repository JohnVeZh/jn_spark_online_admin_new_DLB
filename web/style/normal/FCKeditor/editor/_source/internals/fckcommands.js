...
FCKCommands.GetCommand = function( commandName )
{
	...
	switch ( commandName )
	{
		...
		case 'MyToolBarZhen':oCommand=new FCKDialogCommand('MyToolBarZhen',FCKLang.MyToolBarZhen,'dialog/workflow/fck_ctrl_zhen.html',380,230);break ;
		case 'MyToolBarText':oCommand=new FCKDialogCommand('MyToolBarText',FCKLang.MyToolBarText,'dialog/workflow/fck_ctrl_text.html',380,230);break ;
