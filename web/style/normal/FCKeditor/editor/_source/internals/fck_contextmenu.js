...
function FCK_ContextMenu_GetListener( listenerName )
{
	switch ( listenerName )
	{
		...
		case 'MyToolBarZhen':return{AddItems:function(A,B,C){if(C=='INPUT'&&B.type=='text'&&B.className=='_wf_date'){A.AddSeparator();A.AddItem('CTRL_Input',FCKLang.MyToolBarZhenProp,51);}}};
		case 'MyToolBarText':return{AddItems:function(A,B,C){if(C=='INPUT'&&B.type=='text'&&B.className=='_wf_date1'){A.AddSeparator();A.AddItem('CTRL_Input',FCKLang.MyToolBarTextProp,51);}}};
	}
	return null ;
}
