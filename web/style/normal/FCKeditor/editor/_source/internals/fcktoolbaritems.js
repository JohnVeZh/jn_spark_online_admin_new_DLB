...
FCKToolbarItems.GetItem = function( itemName )
{
	...
	switch ( itemName )
	{
		...
		case 'MyToolBarZhen' 	: oItem=new FCKToolbarButton('MyToolBarZhen',FCKLang.MyToolBarZhen,null,null,null,null,51);break;
		case 'MyToolBarText' 	: oItem=new FCKToolbarButton('MyToolBarText',FCKLang.MyToolBarText,null,null,null,null,51);break;
		default:
