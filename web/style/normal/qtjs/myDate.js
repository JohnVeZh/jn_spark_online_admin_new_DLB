        var dateAll = function ()
        {
            ...
            function e2c()
            {
                ...
                {
                    if (cMonth == Math.floor(CalendarData[m] / 0x10000) + 1) { cMonth = 1 - cMonth; } if (cMonth > Math.floor(CalendarData[m] / 0x10000) + 1)
                    {
                        cMonth--;
                    }
                }
            ...
            //获取农历日期
            this.getLunarCalendar = function ()
            {
