var _ctx = "";
var webFXTreeConfig = {
	rootIcon        : _ctx + '/style/normal/images/home.gif',
	openRootIcon    : _ctx + '/style/normal/images/home.gif',
	folderIcon      : _ctx + '/style/normal/images/xtree_foldericon.gif',
	openFolderIcon  : _ctx + '/style/normal/images/xtree_openfoldericon.gif',
	fileIcon        : _ctx + '/style/normal/images/page.gif',
	iIcon           : _ctx + '/style/normal/images/xtree_I.gif',
	lIcon           : _ctx + '/style/normal/images/xtree_L.gif',
	lMinusIcon      : _ctx + '/style/normal/images/xtree_Lminus.gif',
	lPlusIcon       : _ctx + '/style/normal/images/xtree_Lplus.gif',
	tIcon           : _ctx + '/style/normal/images/xtree_T.gif',
	tMinusIcon      : _ctx + '/style/normal/images/xtree_Tminus.gif',
	tPlusIcon       : _ctx + '/style/normal/images/xtree_Tplus.gif',
	blankIcon       : _ctx + '/style/normal/images/xtree_blank.gif',
...
WebFXCheckBoxTreeItem.prototype.toString = function (nItem, nItemCount) {
	...
	str += "<input type=\"checkbox\"" +
		" class=\"tree-check-box\" id=\""+this.DBID+"\" name=\"DBID\" value=\""+this.DBID+"\" style=\"width:15px; height:15px; \" " +
		(this._checked ? " checked=\"checked\"" : "") +
		" onclick=\"doSelected(true,this)\"" +
		" /><input type=\"hidden\" name=\"DB"+this.parent+"\" value=\""+this.DBID+"\"/>" +
				"<input type=\"hidden\" name=\"Parent"+this.parent+"\" value=\""+this.parent+"\"/>" +
				"<input type=\"hidden\" name=\"DBName\" value=\""+this.text+"\"/>" +
				"<input type=\"hidden\" name=\"ParentId\" value=\""+this.parent+"\"/>";		
	// end insert checkbox
 ...
 * @param {} state
 */
function doChildNodeSelect1(parentId,state){
	var input2 = document.all("Parent"+parentId);
	if(input2 !=null){
	var input1 = document.all("DB"+parentId);
	for(var i=0;i<input2.length;i++){
		document.getElementById(input1[i].value).checked=state;
		doChildNodeSelect1(input1[i].value,state);
	}
  }	
