...
t.dynamic  = true;
t.useCheckbox = false;
t.isParentCheckbox = false;//阃変腑褰揿墠鑺傜偣镞舵槸鍚﹂€変腑鐖惰妭镣?
t.autoFocused = false;//鍒锋柊椤甸溃鏄惁镊姩銮峰缑涓婃铹︾偣
t.useContextMenu = false;
t.convertRootIcon = true;
t.canOperate = false;

t.linkFocus = true;//鍗曞向阈炬帴鏄惁銮峰缑铹︾偣
t.linkCheckbox = false;//鍗曞向阈炬帴鏄惁阃変腑澶嶉€夋
