...
strFrame='<style>';
strFrame+='INPUT.button{BORDER-RIGHT: #48BDA3 1px solid;BORDER-TOP: #48BDA3 1px solid;BORDER-LEFT: #48BDA3 1px solid;';
strFrame+='BORDER-BOTTOM: #48BDA3 1px solid;BACKGROUND-COLOR: #fff8ec;font-family:宋体;}';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 width=142 height=160 bordercolor=#48BDA3 bgcolor=#48BDA3 Author="wayx">';
...
strFrame+='      <tr align=center Author="wayx"><td width=16 align=center bgcolor=#48BDA3 style="font-size:12px;cursor: hand;color: #ffffff" ';
strFrame+='        onclick="parent.meizzPrevM()" title="Front Month" Author=meizz><b Author=meizz>&lt;</b>';
...
strFrame+='        <td width=16 bgcolor=#48BDA3 align=center style="font-size:12px;cursor: hand;color: #ffffff" ';
...
strFrame+='<table border=1 cellspacing=0 cellpadding=0 bgcolor=#48BDA3 ' + (bMoveable? 'onmousedown="DragStart()" onmouseup="DragEnd()"':'');
strFrame+=' BORDERCOLORLIGHT=#48BDA3 BORDERCOLORDARK=#FFFFFF width=140 height=20 Author="wayx" style="cursor:' + (bMoveable ? 'move':'default') + '">';
strFrame+='<tr Author="wayx" align=center valign=bottom><td style="font-size:12px;color:#FFFFFF" Author=meizz>7</td>';
strFrame+='<td style="font-size:12px;color:#FFFFFF" Author=meizz>1</td><td style="font-size:12px;color:#FFFFFF" Author=meizz>2</td>';
strFrame+='<td style="font-size:12px;color:#FFFFFF" Author=meizz>3</td><td style="font-size:12px;color:#FFFFFF" Author=meizz>4</td>';
strFrame+='<td style="font-size:12px;color:#FFFFFF" Author=meizz>5</td><td style="font-size:12px;color:#FFFFFF" Author=meizz>6</td></tr>';
strFrame+='</table></td></tr><!-- Author:F.R.Huang(meizz) http://www.meizz.com/ mail: meizz@hzcnc.com 2002-10-8 -->';
strFrame+='  <tr Author="wayx"><td width=142 height=120 Author="wayx">';
strFrame+='    <table border=1 cellspacing=2 cellpadding=0 BORDERCOLORLIGHT=#48BDA3 BORDERCOLORDARK=#FFFFFF bgcolor=#fff8ec width=140 height=120 Author="wayx">';
...
strFrame+='         Author=meizz title=""><u>Close</u></span>&nbsp;</td></tr>';
strFrame+='    </table></td></tr><tr Author="wayx"><td Author="wayx">';
strFrame+='        <table border=0 cellspacing=1 cellpadding=0 width=100% Author="wayx" bgcolor=#FFFFFF>';
strFrame+='          <tr Author="wayx"><td Author=meizz align=left><input Author=meizz type=button class=button value="<<" title="Front Year" onclick="parent.meizzPrevY()" ';
strFrame+='             onfocus="this.blur()" style="font-size: 12px; height: 20px"><input Author=meizz class=button title="Front Month" type=button ';
...
{
  if (strYear.match(/\D/)!=null){alert("Not number");return;}
...
{
  if (strMonth.match(/\D/)!=null){alert("Month not  number");return;}
...
function meizzToday()  //Today Button
 ...
 var today;
	...
	if (meizzTheMonth<=9) meizzTheMonth="0"+meizzTheMonth;
